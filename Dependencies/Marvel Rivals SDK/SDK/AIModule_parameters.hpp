...
// Function AIModule.AIController.WantsPlayerState
// 0x0001 (0x0001 - 0x0000)
struct AIController_WantsPlayerState final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AIController_WantsPlayerState) == 0x000001, "Wrong alignment on AIController_WantsPlayerState");
static_assert(sizeof(AIController_WantsPlayerState) == 0x000001, "Wrong size on AIController_WantsPlayerState");
static_assert(offsetof(AIController_WantsPlayerState, ReturnValue) == 0x000000, "Member 'AIController_WantsPlayerState::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(PathFollowingComponent_OnActorBump) == 0x000218, "Wrong size on PathFollowingComponent_OnActorBump");
