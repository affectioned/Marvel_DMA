...
static_assert(sizeof(UAbility_102235_BP_C) == 0x0029F8, "Wrong size on UAbility_102235_BP_C");
static_assert(offsetof(UAbility_102235_BP_C, UberGraphFrame) == 0x0029F0, "Member 'UAbility_102235_BP_C::UberGraphFrame' has a wrong offset!");
