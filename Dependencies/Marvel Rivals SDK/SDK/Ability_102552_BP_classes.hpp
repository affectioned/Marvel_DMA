...
static_assert(sizeof(UAbility_102552_BP_C) == 0x002C48, "Wrong size on UAbility_102552_BP_C");
static_assert(offsetof(UAbility_102552_BP_C, UberGraphFrame) == 0x002C40, "Member 'UAbility_102552_BP_C::UberGraphFrame' has a wrong offset!");
