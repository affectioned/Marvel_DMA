...
static_assert(sizeof(UAbility_102721_BP_C) == 0x002A00, "Wrong size on UAbility_102721_BP_C");
static_assert(offsetof(UAbility_102721_BP_C, UberGraphFrame) == 0x0029F8, "Member 'UAbility_102721_BP_C::UberGraphFrame' has a wrong offset!");
