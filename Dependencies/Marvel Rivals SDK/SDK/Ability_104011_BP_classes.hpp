...
static_assert(sizeof(UAbility_104011_BP_C) == 0x002A88, "Wrong size on UAbility_104011_BP_C");
static_assert(offsetof(UAbility_104011_BP_C, UberGraphFrame) == 0x002A80, "Member 'UAbility_104011_BP_C::UberGraphFrame' has a wrong offset!");
