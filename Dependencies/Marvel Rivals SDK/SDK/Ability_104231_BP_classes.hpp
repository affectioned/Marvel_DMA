...
static_assert(sizeof(UAbility_104231_BP_C) == 0x002A18, "Wrong size on UAbility_104231_BP_C");
static_assert(offsetof(UAbility_104231_BP_C, UberGraphFrame) == 0x002A10, "Member 'UAbility_104231_BP_C::UberGraphFrame' has a wrong offset!");
