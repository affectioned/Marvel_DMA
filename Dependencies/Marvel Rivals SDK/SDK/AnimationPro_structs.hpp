...
static_assert(offsetof(FX20LocomotionConfig, FeetCrossingThreshold) == 0x000020, "Member 'FX20LocomotionConfig::FeetCrossingThreshold' has a wrong offset!");
static_assert(offsetof(FX20LocomotionConfig, StateBlendType) == 0x000024, "Member 'FX20LocomotionConfig::StateBlendType' has a wrong offset!");
...
static_assert(sizeof(FMarvelAnimNode_ModifyBoneArray) == 0x000150, "Wrong size on FMarvelAnimNode_ModifyBoneArray");
