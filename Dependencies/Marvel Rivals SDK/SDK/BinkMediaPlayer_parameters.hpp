...
static_assert(alignof(BinkMediaPlayer_SetBinkBufferMode) == 0x000001, "Wrong alignment on BinkMediaPlayer_SetBinkBufferMode");
static_assert(sizeof(BinkMediaPlayer_SetBinkBufferMode) == 0x000001, "Wrong size on BinkMediaPlayer_SetBinkBufferMode");
static_assert(offsetof(BinkMediaPlayer_SetBinkBufferMode, mode) == 0x000000, "Member 'BinkMediaPlayer_SetBinkBufferMode::mode' has a wrong offset!");
...
static_assert(alignof(BinkMediaPlayer_SetVisible) == 0x000001, "Wrong alignment on BinkMediaPlayer_SetVisible");
static_assert(sizeof(BinkMediaPlayer_SetVisible) == 0x000001, "Wrong size on BinkMediaPlayer_SetVisible");
static_assert(offsetof(BinkMediaPlayer_SetVisible, bInVisible) == 0x000000, "Member 'BinkMediaPlayer_SetVisible::bInVisible' has a wrong offset!");
...
static_assert(alignof(BinkMediaPlayer_IsReady) == 0x000001, "Wrong alignment on BinkMediaPlayer_IsReady");
static_assert(sizeof(BinkMediaPlayer_IsReady) == 0x000001, "Wrong size on BinkMediaPlayer_IsReady");
static_assert(offsetof(BinkMediaPlayer_IsReady, ReturnValue) == 0x000000, "Member 'BinkMediaPlayer_IsReady::ReturnValue' has a wrong offset!");
...
static_assert(alignof(BinkMediaPlayer_IsVisible) == 0x000001, "Wrong alignment on BinkMediaPlayer_IsVisible");
static_assert(sizeof(BinkMediaPlayer_IsVisible) == 0x000001, "Wrong size on BinkMediaPlayer_IsVisible");
static_assert(offsetof(BinkMediaPlayer_IsVisible, ReturnValue) == 0x000000, "Member 'BinkMediaPlayer_IsVisible::ReturnValue' has a wrong offset!");
