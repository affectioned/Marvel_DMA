...
{
public:
	class UComputeGraph*                          ComputeGraph;                                      // 0x0108(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FComputeGraphInstance                  ComputeGraphInstance;                              // 0x0110(0x0018)(NativeAccessSpecifierPrivate)
