...
TSet<class FString> UUnitHitEvent::GetEventHeroIDsAll()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UnitHitEvent", "GetEventHeroIDsAll");

	Params::UnitHitEvent_GetEventHeroIDsAll Parms{};
...
TArray<struct FDependencyHeroIDSet> UUnitHitEvent::GetEventHeroIDsAny()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UnitHitEvent", "GetEventHeroIDsAny");

	Params::UnitHitEvent_GetEventHeroIDsAny Parms{};
