...
public:
	...
	bool                                          bPartialMatchKey;                                  // 0x0014(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(DatasmithContentBlueprintLibrary_GetDatasmithUserDataValueForKey, bPartialMatchKey) == 0x000014, "Member 'DatasmithContentBlueprintLibrary_GetDatasmithUserDataValueForKey::bPartialMatchKey' has a wrong offset!");
...
static_assert(offsetof(DatasmithContentBlueprintLibrary_GetDatasmithUserDataValuesForKey, bPartialMatchKey) == 0x000014, "Member 'DatasmithContentBlueprintLibrary_GetDatasmithUserDataValuesForKey::bPartialMatchKey' has a wrong offset!");
