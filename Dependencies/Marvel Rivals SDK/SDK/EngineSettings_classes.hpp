...
class UPSOMtlMarkSettings final : public UDeveloperSettings
{
public:
	TArray<class FString>                         MtlMarkList;                                       // 0x0048(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	uint64                                        PSOMarkValue;                                      // 0x0058(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
