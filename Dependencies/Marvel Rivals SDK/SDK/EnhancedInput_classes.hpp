...
{
public:
	TMap<class UInputAction*, struct FKeyConsumptionOptions> KeyConsumptionData;                     // 0x0518(0x0050)(Protected, NativeAccessSpecifierProtected)
	TMap<class UInputMappingContext*, int32>      AppliedInputContexts;                              // 0x0568(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TArray<struct FEnhancedActionKeyMapping>      EnhancedActionMappings;                            // 0x05B8(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_5C8[0x50];                                     // 0x05C8(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class UInputAction*, struct FInputActionInstance> ActionInstanceData;                       // 0x0618(0x0050)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_668[0xA0];                                     // 0x0668(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FKey, struct FVector>             KeysPressedThisTick;                               // 0x0708(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<class UInputAction*, struct FInjectedInputArray> InputsInjectedThisTick;                    // 0x0758(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TSet<class UInputAction*>                     LastInjectedActions;                               // 0x07A8(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_7F8[0x78];                                     // 0x07F8(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
