...
public:
	...
	bool                                          bSwitchConfirmAndCancelKeysAccordingSettings;      // 0x004A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPlayerMappableKeySettingBehaviors            SettingBehavior;                                   // 0x004B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(FEnhancedActionKeyMapping, bSwitchConfirmAndCancelKeysAccordingSettings) == 0x00004A, "Member 'FEnhancedActionKeyMapping::bSwitchConfirmAndCancelKeysAccordingSettings' has a wrong offset!");
static_assert(offsetof(FEnhancedActionKeyMapping, SettingBehavior) == 0x00004B, "Member 'FEnhancedActionKeyMapping::SettingBehavior' has a wrong offset!");
