...
static_assert(sizeof(GameplayBehaviorsBlueprintFunctionLibrary_AddGameplayTagFilterToBlackboardKeySelector) == 0x000048, "Wrong size on GameplayBehaviorsBlueprintFunctionLibrary_AddGameplayTagFilterToBlackboardKeySelector");
...
static_assert(offsetof(GameplayBehaviorsBlueprintFunctionLibrary_AddGameplayTagFilterToBlackboardKeySelector, Owner) == 0x000030, "Member 'GameplayBehaviorsBlueprintFunctionLibrary_AddGameplayTagFilterToBlackboardKeySelector::Owner' has a wrong offset!");
static_assert(offsetof(GameplayBehaviorsBlueprintFunctionLibrary_AddGameplayTagFilterToBlackboardKeySelector, PropertyName) == 0x000038, "Member 'GameplayBehaviorsBlueprintFunctionLibrary_AddGameplayTagFilterToBlackboardKeySelector::PropertyName' has a wrong offset!");
...
public:
	...
	struct FGameplayTagContainer                  ReturnValue;                                       // 0x0038(0x0068)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(GameplayBehaviorsBlueprintFunctionLibrary_GetBlackboardValueAsGameplayTag) == 0x0000A0, "Wrong size on GameplayBehaviorsBlueprintFunctionLibrary_GetBlackboardValueAsGameplayTag");
...
static_assert(offsetof(GameplayBehaviorsBlueprintFunctionLibrary_GetBlackboardValueAsGameplayTag, ReturnValue) == 0x000038, "Member 'GameplayBehaviorsBlueprintFunctionLibrary_GetBlackboardValueAsGameplayTag::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FGameplayTagContainer                  ReturnValue;                                       // 0x0018(0x0068)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(GameplayBehaviorsBlueprintFunctionLibrary_GetBlackboardValueAsGameplayTagFromBlackboardComp) == 0x000080, "Wrong size on GameplayBehaviorsBlueprintFunctionLibrary_GetBlackboardValueAsGameplayTagFromBlackboardComp");
...
static_assert(offsetof(GameplayBehaviorsBlueprintFunctionLibrary_GetBlackboardValueAsGameplayTagFromBlackboardComp, ReturnValue) == 0x000018, "Member 'GameplayBehaviorsBlueprintFunctionLibrary_GetBlackboardValueAsGameplayTagFromBlackboardComp::ReturnValue' has a wrong offset!");
...
public:
	class UBTNode*                                NodeOwner;                                         // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBlackboardKeySelector                 Key;                                               // 0x0008(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  Value;                                             // 0x0038(0x0068)(Parm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(GameplayBehaviorsBlueprintFunctionLibrary_SetBlackboardValueAsGameplayTag) == 0x0000A0, "Wrong size on GameplayBehaviorsBlueprintFunctionLibrary_SetBlackboardValueAsGameplayTag");
...
static_assert(offsetof(GameplayBehaviorsBlueprintFunctionLibrary_SetBlackboardValueAsGameplayTag, Value) == 0x000038, "Member 'GameplayBehaviorsBlueprintFunctionLibrary_SetBlackboardValueAsGameplayTag::Value' has a wrong offset!");
...
public:
	...
	class FName                                   KeyName;                                           // 0x0008(0x000C)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  GameplayTagValue;                                  // 0x0018(0x0068)(Parm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(GameplayBehaviorsBlueprintFunctionLibrary_SetValueAsGameplayTagForBlackboardComp) == 0x000080, "Wrong size on GameplayBehaviorsBlueprintFunctionLibrary_SetValueAsGameplayTagForBlackboardComp");
...
static_assert(offsetof(GameplayBehaviorsBlueprintFunctionLibrary_SetValueAsGameplayTagForBlackboardComp, GameplayTagValue) == 0x000018, "Member 'GameplayBehaviorsBlueprintFunctionLibrary_SetValueAsGameplayTagForBlackboardComp::GameplayTagValue' has a wrong offset!");
