...
public:
	...
	struct FMinimalViewInfo                       POV;                                               // 0x0010(0x0A60)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FMinimalViewInfo                       ModifiedPOV;                                       // 0x0A70(0x0A60)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(LegacyCameraShake_BlueprintUpdateCameraShake) == 0x0014D0, "Wrong size on LegacyCameraShake_BlueprintUpdateCameraShake");
...
static_assert(offsetof(LegacyCameraShake_BlueprintUpdateCameraShake, ModifiedPOV) == 0x000A70, "Member 'LegacyCameraShake_BlueprintUpdateCameraShake::ModifiedPOV' has a wrong offset!");
