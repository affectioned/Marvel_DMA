...
enum class EInitialOscillatorOffset : uint8
{
	EOO_OffsetRandom                         = 0,
	EOO_OffsetZero                           = 1,
	EOO_OffsetRandomPositive                 = 2,
	EOO_OffsetRandomNegative                 = 3,
	EOO_OffsetCrest                          = 4,
	EOO_OffsetTrough                         = 5,
	EOO_MAX                                  = 6,
};
...
public:
	...
	float                                         AmplitudeEnhanced;                                 // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	EInitialOscillatorOffset                      InitialOffset;                                     // 0x000C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
