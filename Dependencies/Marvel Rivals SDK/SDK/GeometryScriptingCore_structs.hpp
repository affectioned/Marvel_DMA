...
static_assert(sizeof(FGeometryScriptBoneWeightProfile) == 0x00000C, "Wrong size on FGeometryScriptBoneWeightProfile");
...
static_assert(sizeof(FGeometryScriptTransferBoneWeightsOptions) == 0x000048, "Wrong size on FGeometryScriptTransferBoneWeightsOptions");
...
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, TargetProfile) == 0x000010, "Member 'FGeometryScriptTransferBoneWeightsOptions::TargetProfile' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, RadiusPercentage) == 0x000020, "Member 'FGeometryScriptTransferBoneWeightsOptions::RadiusPercentage' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, NormalThreshold) == 0x000028, "Member 'FGeometryScriptTransferBoneWeightsOptions::NormalThreshold' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, LayeredMeshSupport) == 0x000030, "Member 'FGeometryScriptTransferBoneWeightsOptions::LayeredMeshSupport' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, NumSmoothingIterations) == 0x000034, "Member 'FGeometryScriptTransferBoneWeightsOptions::NumSmoothingIterations' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, SmoothingStrength) == 0x000038, "Member 'FGeometryScriptTransferBoneWeightsOptions::SmoothingStrength' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, InpaintMask) == 0x00003C, "Member 'FGeometryScriptTransferBoneWeightsOptions::InpaintMask' has a wrong offset!");
...
static_assert(sizeof(FGeometryScriptBoneInfo) == 0x0000F0, "Wrong size on FGeometryScriptBoneInfo");
...
static_assert(offsetof(FGeometryScriptBoneInfo, ParentIndex) == 0x000010, "Member 'FGeometryScriptBoneInfo::ParentIndex' has a wrong offset!");
static_assert(offsetof(FGeometryScriptBoneInfo, LocalTransform) == 0x000020, "Member 'FGeometryScriptBoneInfo::LocalTransform' has a wrong offset!");
static_assert(offsetof(FGeometryScriptBoneInfo, WorldTransform) == 0x000080, "Member 'FGeometryScriptBoneInfo::WorldTransform' has a wrong offset!");
static_assert(offsetof(FGeometryScriptBoneInfo, Color) == 0x0000E0, "Member 'FGeometryScriptBoneInfo::Color' has a wrong offset!");
