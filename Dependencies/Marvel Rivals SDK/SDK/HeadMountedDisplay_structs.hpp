...
static_assert(offsetof(FXRHMDData, Position) == 0x000028, "Member 'FXRHMDData::Position' has a wrong offset!");
...
static_assert(offsetof(FXRMotionControllerData, GripPosition) == 0x000028, "Member 'FXRMotionControllerData::GripPosition' has a wrong offset!");
