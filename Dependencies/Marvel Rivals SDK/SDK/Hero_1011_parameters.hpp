...
static_assert(alignof(HulkBannerMoveLogicBaseComponent_HandleIgnoreSpringBoard) == 0x000001, "Wrong alignment on HulkBannerMoveLogicBaseComponent_HandleIgnoreSpringBoard");
static_assert(sizeof(HulkBannerMoveLogicBaseComponent_HandleIgnoreSpringBoard) == 0x000001, "Wrong size on HulkBannerMoveLogicBaseComponent_HandleIgnoreSpringBoard");
static_assert(offsetof(HulkBannerMoveLogicBaseComponent_HandleIgnoreSpringBoard, bIgnore) == 0x000000, "Member 'HulkBannerMoveLogicBaseComponent_HandleIgnoreSpringBoard::bIgnore' has a wrong offset!");
...
static_assert(sizeof(HulkBannerMoveLogicBaseComponent_OnFallingBlockedCallback) == 0x0001F0, "Wrong size on HulkBannerMoveLogicBaseComponent_OnFallingBlockedCallback");
...
static_assert(sizeof(HulkBannerMoveLogicBaseComponent_OnLandedCallback) == 0x0001F0, "Wrong size on HulkBannerMoveLogicBaseComponent_OnLandedCallback");
...
static_assert(alignof(HulkBannerMoveLogicBaseComponent_TriggerClimbToShiftTurn) == 0x000008, "Wrong alignment on HulkBannerMoveLogicBaseComponent_TriggerClimbToShiftTurn");
static_assert(sizeof(HulkBannerMoveLogicBaseComponent_TriggerClimbToShiftTurn) == 0x000008, "Wrong size on HulkBannerMoveLogicBaseComponent_TriggerClimbToShiftTurn");
static_assert(offsetof(HulkBannerMoveLogicBaseComponent_TriggerClimbToShiftTurn, ShiftJumpAbility) == 0x000000, "Member 'HulkBannerMoveLogicBaseComponent_TriggerClimbToShiftTurn::ShiftJumpAbility' has a wrong offset!");
...
public:
	class AActor*                                 Source;                                            // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayEffectSpec                    BlockedSpec;                                       // 0x0008(0x09F0)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(EpicMomentAction_1011_OnEffectImmunityOrInhibitedCallback) == 0x0009F8, "Wrong size on EpicMomentAction_1011_OnEffectImmunityOrInhibitedCallback");
...
static_assert(sizeof(HulkBannerCharacter_TryToClimbWhenHit) == 0x000220, "Wrong size on HulkBannerCharacter_TryToClimbWhenHit");
