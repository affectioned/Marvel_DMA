...
static_assert(alignof(SummonedComp_V2_10165101_OnBondStateChanged) == 0x000008, "Wrong alignment on SummonedComp_V2_10165101_OnBondStateChanged");
static_assert(sizeof(SummonedComp_V2_10165101_OnBondStateChanged) == 0x000138, "Wrong size on SummonedComp_V2_10165101_OnBondStateChanged");
static_assert(offsetof(SummonedComp_V2_10165101_OnBondStateChanged, InBondInstance) == 0x000000, "Member 'SummonedComp_V2_10165101_OnBondStateChanged::InBondInstance' has a wrong offset!");
static_assert(offsetof(SummonedComp_V2_10165101_OnBondStateChanged, TriggerCharacter) == 0x000128, "Member 'SummonedComp_V2_10165101_OnBondStateChanged::TriggerCharacter' has a wrong offset!");
static_assert(offsetof(SummonedComp_V2_10165101_OnBondStateChanged, bActive) == 0x000130, "Member 'SummonedComp_V2_10165101_OnBondStateChanged::bActive' has a wrong offset!");
...
static_assert(alignof(SummonedComp_V2_10165101_OnInstigatorActivateAbility) == 0x000008, "Wrong alignment on SummonedComp_V2_10165101_OnInstigatorActivateAbility");
static_assert(sizeof(SummonedComp_V2_10165101_OnInstigatorActivateAbility) == 0x000008, "Wrong size on SummonedComp_V2_10165101_OnInstigatorActivateAbility");
static_assert(offsetof(SummonedComp_V2_10165101_OnInstigatorActivateAbility, InAbility) == 0x000000, "Member 'SummonedComp_V2_10165101_OnInstigatorActivateAbility::InAbility' has a wrong offset!");
...
static_assert(sizeof(Ability_101661_OnDisguiseEffectRemoved) == 0x000038, "Wrong size on Ability_101661_OnDisguiseEffectRemoved");
...
static_assert(alignof(LokiPhantomAnimInstanceV2_OnMontageStart) == 0x000008, "Wrong alignment on LokiPhantomAnimInstanceV2_OnMontageStart");
static_assert(sizeof(LokiPhantomAnimInstanceV2_OnMontageStart) == 0x000008, "Wrong size on LokiPhantomAnimInstanceV2_OnMontageStart");
static_assert(offsetof(LokiPhantomAnimInstanceV2_OnMontageStart, AnimMontage) == 0x000000, "Member 'LokiPhantomAnimInstanceV2_OnMontageStart::AnimMontage' has a wrong offset!");
...
static_assert(alignof(LokiPhantomAnimInstanceV2_GetCurrentUpperBodyBlendSwitch) == 0x000001, "Wrong alignment on LokiPhantomAnimInstanceV2_GetCurrentUpperBodyBlendSwitch");
static_assert(sizeof(LokiPhantomAnimInstanceV2_GetCurrentUpperBodyBlendSwitch) == 0x00000A, "Wrong size on LokiPhantomAnimInstanceV2_GetCurrentUpperBodyBlendSwitch");
static_assert(offsetof(LokiPhantomAnimInstanceV2_GetCurrentUpperBodyBlendSwitch, ReturnValue) == 0x000000, "Member 'LokiPhantomAnimInstanceV2_GetCurrentUpperBodyBlendSwitch::ReturnValue' has a wrong offset!");
