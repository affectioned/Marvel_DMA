...
static_assert(sizeof(DragAbility_102161_OnCharacterHit) == 0x000218, "Wrong size on DragAbility_102161_OnCharacterHit");
...
static_assert(alignof(Cue_Summoner_Loop_10218101_IgnoreSetCustomStencil) == 0x000001, "Wrong alignment on Cue_Summoner_Loop_10218101_IgnoreSetCustomStencil");
static_assert(sizeof(Cue_Summoner_Loop_10218101_IgnoreSetCustomStencil) == 0x000001, "Wrong size on Cue_Summoner_Loop_10218101_IgnoreSetCustomStencil");
static_assert(offsetof(Cue_Summoner_Loop_10218101_IgnoreSetCustomStencil, ReturnValue) == 0x000000, "Member 'Cue_Summoner_Loop_10218101_IgnoreSetCustomStencil::ReturnValue' has a wrong offset!");
...
static_assert(alignof(Projectile_10219301_IsTargetRecorded) == 0x000008, "Wrong alignment on Projectile_10219301_IsTargetRecorded");
static_assert(sizeof(Projectile_10219301_IsTargetRecorded) == 0x000010, "Wrong size on Projectile_10219301_IsTargetRecorded");
static_assert(offsetof(Projectile_10219301_IsTargetRecorded, Target) == 0x000000, "Member 'Projectile_10219301_IsTargetRecorded::Target' has a wrong offset!");
static_assert(offsetof(Projectile_10219301_IsTargetRecorded, ReturnValue) == 0x000008, "Member 'Projectile_10219301_IsTargetRecorded::ReturnValue' has a wrong offset!");
...
static_assert(alignof(Projectile_10219301_RecordTarget) == 0x000008, "Wrong alignment on Projectile_10219301_RecordTarget");
static_assert(sizeof(Projectile_10219301_RecordTarget) == 0x000008, "Wrong size on Projectile_10219301_RecordTarget");
static_assert(offsetof(Projectile_10219301_RecordTarget, Target) == 0x000000, "Member 'Projectile_10219301_RecordTarget::Target' has a wrong offset!");
...
static_assert(alignof(Projectile_10219301_SetSecondStage) == 0x000001, "Wrong alignment on Projectile_10219301_SetSecondStage");
static_assert(sizeof(Projectile_10219301_SetSecondStage) == 0x000001, "Wrong size on Projectile_10219301_SetSecondStage");
static_assert(offsetof(Projectile_10219301_SetSecondStage, bEnterSecondStage) == 0x000000, "Member 'Projectile_10219301_SetSecondStage::bEnterSecondStage' has a wrong offset!");
