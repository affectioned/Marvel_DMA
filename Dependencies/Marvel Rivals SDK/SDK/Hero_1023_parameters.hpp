...
static_assert(alignof(AbilityModifier_Base_ExecuteModifyBeforeAbilityActive) == 0x000008, "Wrong alignment on AbilityModifier_Base_ExecuteModifyBeforeAbilityActive");
static_assert(sizeof(AbilityModifier_Base_ExecuteModifyBeforeAbilityActive) == 0x000008, "Wrong size on AbilityModifier_Base_ExecuteModifyBeforeAbilityActive");
static_assert(offsetof(AbilityModifier_Base_ExecuteModifyBeforeAbilityActive, Ability) == 0x000000, "Member 'AbilityModifier_Base_ExecuteModifyBeforeAbilityActive::Ability' has a wrong offset!");
...
static_assert(alignof(AbilityModifier_Base_ExecuteModifyOnApply) == 0x000008, "Wrong alignment on AbilityModifier_Base_ExecuteModifyOnApply");
static_assert(sizeof(AbilityModifier_Base_ExecuteModifyOnApply) == 0x000008, "Wrong size on AbilityModifier_Base_ExecuteModifyOnApply");
static_assert(offsetof(AbilityModifier_Base_ExecuteModifyOnApply, Ability) == 0x000000, "Member 'AbilityModifier_Base_ExecuteModifyOnApply::Ability' has a wrong offset!");
...
static_assert(alignof(AbilityModifier_Base_RevertModifyOnRemove) == 0x000008, "Wrong alignment on AbilityModifier_Base_RevertModifyOnRemove");
static_assert(sizeof(AbilityModifier_Base_RevertModifyOnRemove) == 0x000008, "Wrong size on AbilityModifier_Base_RevertModifyOnRemove");
static_assert(offsetof(AbilityModifier_Base_RevertModifyOnRemove, Ability) == 0x000000, "Member 'AbilityModifier_Base_RevertModifyOnRemove::Ability' has a wrong offset!");
...
static_assert(alignof(SummonedModifier_Base_ExecuteModifyWhileSummonedInitData) == 0x000008, "Wrong alignment on SummonedModifier_Base_ExecuteModifyWhileSummonedInitData");
static_assert(sizeof(SummonedModifier_Base_ExecuteModifyWhileSummonedInitData) == 0x000008, "Wrong size on SummonedModifier_Base_ExecuteModifyWhileSummonedInitData");
static_assert(offsetof(SummonedModifier_Base_ExecuteModifyWhileSummonedInitData, SummonedComponent) == 0x000000, "Member 'SummonedModifier_Base_ExecuteModifyWhileSummonedInitData::SummonedComponent' has a wrong offset!");
...
static_assert(alignof(AbilityModifierComponent_AddAbilityModifier) == 0x000008, "Wrong alignment on AbilityModifierComponent_AddAbilityModifier");
static_assert(sizeof(AbilityModifierComponent_AddAbilityModifier) == 0x000018, "Wrong size on AbilityModifierComponent_AddAbilityModifier");
static_assert(offsetof(AbilityModifierComponent_AddAbilityModifier, AbilityID) == 0x000000, "Member 'AbilityModifierComponent_AddAbilityModifier::AbilityID' has a wrong offset!");
static_assert(offsetof(AbilityModifierComponent_AddAbilityModifier, Modifier) == 0x000008, "Member 'AbilityModifierComponent_AddAbilityModifier::Modifier' has a wrong offset!");
static_assert(offsetof(AbilityModifierComponent_AddAbilityModifier, ReturnValue) == 0x000010, "Member 'AbilityModifierComponent_AddAbilityModifier::ReturnValue' has a wrong offset!");
...
{
public:
	struct FScopeBuffSpecModifier                 Modifier;                                          // 0x0000(0x0108)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AbilityModifierComponent_AddScopeBuffSpecModifier) == 0x000108, "Wrong size on AbilityModifierComponent_AddScopeBuffSpecModifier");
...
static_assert(alignof(AbilityModifierComponent_AddSummonedModifier) == 0x000008, "Wrong alignment on AbilityModifierComponent_AddSummonedModifier");
static_assert(sizeof(AbilityModifierComponent_AddSummonedModifier) == 0x000018, "Wrong size on AbilityModifierComponent_AddSummonedModifier");
static_assert(offsetof(AbilityModifierComponent_AddSummonedModifier, SummonedID) == 0x000000, "Member 'AbilityModifierComponent_AddSummonedModifier::SummonedID' has a wrong offset!");
static_assert(offsetof(AbilityModifierComponent_AddSummonedModifier, Modifier) == 0x000008, "Member 'AbilityModifierComponent_AddSummonedModifier::Modifier' has a wrong offset!");
static_assert(offsetof(AbilityModifierComponent_AddSummonedModifier, ReturnValue) == 0x000010, "Member 'AbilityModifierComponent_AddSummonedModifier::ReturnValue' has a wrong offset!");
...
static_assert(alignof(AbilityModifierComponent_RemoveAbilityModifier) == 0x000008, "Wrong alignment on AbilityModifierComponent_RemoveAbilityModifier");
static_assert(sizeof(AbilityModifierComponent_RemoveAbilityModifier) == 0x000008, "Wrong size on AbilityModifierComponent_RemoveAbilityModifier");
static_assert(offsetof(AbilityModifierComponent_RemoveAbilityModifier, Modifier) == 0x000000, "Member 'AbilityModifierComponent_RemoveAbilityModifier::Modifier' has a wrong offset!");
...
static_assert(sizeof(AbilityModifierComponent_RemoveScopeBuffSpecModifier) == 0x000108, "Wrong size on AbilityModifierComponent_RemoveScopeBuffSpecModifier");
...
static_assert(alignof(AbilityModifierComponent_RemoveSummonedModifier) == 0x000008, "Wrong alignment on AbilityModifierComponent_RemoveSummonedModifier");
static_assert(sizeof(AbilityModifierComponent_RemoveSummonedModifier) == 0x000008, "Wrong size on AbilityModifierComponent_RemoveSummonedModifier");
static_assert(offsetof(AbilityModifierComponent_RemoveSummonedModifier, Modifier) == 0x000000, "Member 'AbilityModifierComponent_RemoveSummonedModifier::Modifier' has a wrong offset!");
...
static_assert(alignof(SummonedComp_10234101_SetCanRespawnOwnerCharacter) == 0x000001, "Wrong alignment on SummonedComp_10234101_SetCanRespawnOwnerCharacter");
static_assert(sizeof(SummonedComp_10234101_SetCanRespawnOwnerCharacter) == 0x000001, "Wrong size on SummonedComp_10234101_SetCanRespawnOwnerCharacter");
static_assert(offsetof(SummonedComp_10234101_SetCanRespawnOwnerCharacter, bInValue) == 0x000000, "Member 'SummonedComp_10234101_SetCanRespawnOwnerCharacter::bInValue' has a wrong offset!");
...
static_assert(alignof(Summoner_102382_SetInitFlyDirection) == 0x000008, "Wrong alignment on Summoner_102382_SetInitFlyDirection");
static_assert(sizeof(Summoner_102382_SetInitFlyDirection) == 0x000018, "Wrong size on Summoner_102382_SetInitFlyDirection");
static_assert(offsetof(Summoner_102382_SetInitFlyDirection, InVelocity) == 0x000000, "Member 'Summoner_102382_SetInitFlyDirection::InVelocity' has a wrong offset!");
