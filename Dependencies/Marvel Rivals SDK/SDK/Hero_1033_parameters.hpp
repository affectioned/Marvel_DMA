...
public:
	...
	struct FMarvelEquipmentTable                  WeaponInfo;                                        // 0x0008(0x02B8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                          bState;                                            // 0x02C0(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(Ability_103303_OnWeaponSwitchedReplicated) == 0x0002C8, "Wrong size on Ability_103303_OnWeaponSwitchedReplicated");
...
static_assert(offsetof(Ability_103303_OnWeaponSwitchedReplicated, bState) == 0x0002C0, "Member 'Ability_103303_OnWeaponSwitchedReplicated::bState' has a wrong offset!");
...
static_assert(alignof(BlackWidowLibrary_InitAutoSwitchSniper) == 0x000008, "Wrong alignment on BlackWidowLibrary_InitAutoSwitchSniper");
static_assert(sizeof(BlackWidowLibrary_InitAutoSwitchSniper) == 0x000010, "Wrong size on BlackWidowLibrary_InitAutoSwitchSniper");
static_assert(offsetof(BlackWidowLibrary_InitAutoSwitchSniper, AutoSwitchSniper) == 0x000000, "Member 'BlackWidowLibrary_InitAutoSwitchSniper::AutoSwitchSniper' has a wrong offset!");
static_assert(offsetof(BlackWidowLibrary_InitAutoSwitchSniper, InOwnerAbility) == 0x000008, "Member 'BlackWidowLibrary_InitAutoSwitchSniper::InOwnerAbility' has a wrong offset!");
...
static_assert(alignof(BlackWidowLibrary_IsSniperReady) == 0x000008, "Wrong alignment on BlackWidowLibrary_IsSniperReady");
static_assert(sizeof(BlackWidowLibrary_IsSniperReady) == 0x000010, "Wrong size on BlackWidowLibrary_IsSniperReady");
static_assert(offsetof(BlackWidowLibrary_IsSniperReady, AutoSwitchSniper) == 0x000000, "Member 'BlackWidowLibrary_IsSniperReady::AutoSwitchSniper' has a wrong offset!");
static_assert(offsetof(BlackWidowLibrary_IsSniperReady, ReturnValue) == 0x000008, "Member 'BlackWidowLibrary_IsSniperReady::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BlackWidowSniperGun_OnOwnerCharacterRespawned) == 0x000820, "Wrong size on BlackWidowSniperGun_OnOwnerCharacterRespawned");
