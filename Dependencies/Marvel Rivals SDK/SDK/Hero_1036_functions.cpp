...
// Parameters:
// const struct FPortalSegments            ReturnValue                                            (ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)

const struct FPortalSegments UAbility_103614::GetPortalSegments()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ability_103614", "GetPortalSegments");

	Params::Ability_103614_GetPortalSegments Parms{};
...
// Parameters:
// const struct FPortalSegments&           InTargetPortalSegment                                  (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UAbility_103614::SetPortalSegments(const struct FPortalSegments& InTargetPortalSegment)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ability_103614", "SetPortalSegments");

	Params::Ability_103614_SetPortalSegments Parms{};

	Parms.InTargetPortalSegment = std::move(InTargetPortalSegment);
...
// const struct FPredictionKey&            SyncKey                                                (ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ASpiderManCharacter::ServerChangeGravityScale(float NewGravityScale, const struct FPredictionKey& SyncKey)
{
	static class UFunction* Func = nullptr;
	...
	Parms.SyncKey = std::move(SyncKey);
