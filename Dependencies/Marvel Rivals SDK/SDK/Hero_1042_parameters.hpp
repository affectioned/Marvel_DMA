...
static_assert(sizeof(Summoned_10424102_OnSpiderProjectileStop) == 0x0001F0, "Wrong size on Summoned_10424102_OnSpiderProjectileStop");
...
{
public:
	struct FMarvelAbilityTraceContext             ReturnValue;                                       // 0x0000(0x1660)(Parm, OutParm, ReturnParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(Summoned_10424103_GetDetectTraceContext) == 0x000010, "Wrong alignment on Summoned_10424103_GetDetectTraceContext");
static_assert(sizeof(Summoned_10424103_GetDetectTraceContext) == 0x001660, "Wrong size on Summoned_10424103_GetDetectTraceContext");
static_assert(offsetof(Summoned_10424103_GetDetectTraceContext, ReturnValue) == 0x000000, "Member 'Summoned_10424103_GetDetectTraceContext::ReturnValue' has a wrong offset!");
...
static_assert(alignof(SummonedComp_10424103_GetWebMaxOffsetDistance) == 0x000004, "Wrong alignment on SummonedComp_10424103_GetWebMaxOffsetDistance");
static_assert(sizeof(SummonedComp_10424103_GetWebMaxOffsetDistance) == 0x000004, "Wrong size on SummonedComp_10424103_GetWebMaxOffsetDistance");
static_assert(offsetof(SummonedComp_10424103_GetWebMaxOffsetDistance, ReturnValue) == 0x000000, "Member 'SummonedComp_10424103_GetWebMaxOffsetDistance::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(TraceComponent_10424103_OnPreOutTraceResults) == 0x0001F8, "Wrong size on TraceComponent_10424103_OnPreOutTraceResults");
...
static_assert(offsetof(TraceComponent_10424103_OnPreOutTraceResults, ReturnValue) == 0x0001F0, "Member 'TraceComponent_10424103_OnPreOutTraceResults::ReturnValue' has a wrong offset!");
...
static_assert(alignof(Cue_Summoner_Loop_10424105_ShouldStartWebTimelines) == 0x000001, "Wrong alignment on Cue_Summoner_Loop_10424105_ShouldStartWebTimelines");
static_assert(sizeof(Cue_Summoner_Loop_10424105_ShouldStartWebTimelines) == 0x000001, "Wrong size on Cue_Summoner_Loop_10424105_ShouldStartWebTimelines");
static_assert(offsetof(Cue_Summoner_Loop_10424105_ShouldStartWebTimelines, ReturnValue) == 0x000000, "Member 'Cue_Summoner_Loop_10424105_ShouldStartWebTimelines::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(EpicMomentAction_1042_OnProjectileHit) == 0x0001F0, "Wrong size on EpicMomentAction_1042_OnProjectileHit");
