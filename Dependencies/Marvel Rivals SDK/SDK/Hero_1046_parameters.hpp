...
public:
	...
	struct FHitResult                             OutHitResult;                                      // 0x0050(0x01F0)(Parm, OutParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bCheckBlockingVolume;                              // 0x0240(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0241(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_242[0x6];                                      // 0x0242(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(Ability_104661_CheckSceneBlockBySphereTrace) == 0x000008, "Wrong alignment on Ability_104661_CheckSceneBlockBySphereTrace");
static_assert(sizeof(Ability_104661_CheckSceneBlockBySphereTrace) == 0x000248, "Wrong size on Ability_104661_CheckSceneBlockBySphereTrace");
static_assert(offsetof(Ability_104661_CheckSceneBlockBySphereTrace, WorldContextObject) == 0x000000, "Member 'Ability_104661_CheckSceneBlockBySphereTrace::WorldContextObject' has a wrong offset!");
static_assert(offsetof(Ability_104661_CheckSceneBlockBySphereTrace, Start) == 0x000008, "Member 'Ability_104661_CheckSceneBlockBySphereTrace::Start' has a wrong offset!");
static_assert(offsetof(Ability_104661_CheckSceneBlockBySphereTrace, End) == 0x000020, "Member 'Ability_104661_CheckSceneBlockBySphereTrace::End' has a wrong offset!");
static_assert(offsetof(Ability_104661_CheckSceneBlockBySphereTrace, Radius) == 0x000038, "Member 'Ability_104661_CheckSceneBlockBySphereTrace::Radius' has a wrong offset!");
static_assert(offsetof(Ability_104661_CheckSceneBlockBySphereTrace, Ignores) == 0x000040, "Member 'Ability_104661_CheckSceneBlockBySphereTrace::Ignores' has a wrong offset!");
static_assert(offsetof(Ability_104661_CheckSceneBlockBySphereTrace, OutHitResult) == 0x000050, "Member 'Ability_104661_CheckSceneBlockBySphereTrace::OutHitResult' has a wrong offset!");
static_assert(offsetof(Ability_104661_CheckSceneBlockBySphereTrace, bCheckBlockingVolume) == 0x000240, "Member 'Ability_104661_CheckSceneBlockBySphereTrace::bCheckBlockingVolume' has a wrong offset!");
static_assert(offsetof(Ability_104661_CheckSceneBlockBySphereTrace, ReturnValue) == 0x000241, "Member 'Ability_104661_CheckSceneBlockBySphereTrace::ReturnValue' has a wrong offset!");
...
static_assert(alignof(Ability_104661_IsSummonerUnderDeathZone) == 0x000008, "Wrong alignment on Ability_104661_IsSummonerUnderDeathZone");
static_assert(sizeof(Ability_104661_IsSummonerUnderDeathZone) == 0x000038, "Wrong size on Ability_104661_IsSummonerUnderDeathZone");
static_assert(offsetof(Ability_104661_IsSummonerUnderDeathZone, InStart) == 0x000000, "Member 'Ability_104661_IsSummonerUnderDeathZone::InStart' has a wrong offset!");
static_assert(offsetof(Ability_104661_IsSummonerUnderDeathZone, InEnd) == 0x000018, "Member 'Ability_104661_IsSummonerUnderDeathZone::InEnd' has a wrong offset!");
static_assert(offsetof(Ability_104661_IsSummonerUnderDeathZone, InRadius) == 0x000030, "Member 'Ability_104661_IsSummonerUnderDeathZone::InRadius' has a wrong offset!");
static_assert(offsetof(Ability_104661_IsSummonerUnderDeathZone, ReturnValue) == 0x000034, "Member 'Ability_104661_IsSummonerUnderDeathZone::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Cue_Buff_10466103_OnOwnerRebornReset) == 0x000820, "Wrong size on Cue_Buff_10466103_OnOwnerRebornReset");
...
public:
	...
	struct FAttributeModifierParameter            ModifierParameter;                                 // 0x0010(0x07A0)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(EpicMomentAction_1046_OnActorResurrected) == 0x0007B0, "Wrong size on EpicMomentAction_1046_OnActorResurrected");
