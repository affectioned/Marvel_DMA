...
static_assert(alignof(Summoned_10504101_OnActorOverlap) == 0x000008, "Wrong alignment on Summoned_10504101_OnActorOverlap");
static_assert(sizeof(Summoned_10504101_OnActorOverlap) == 0x000008, "Wrong size on Summoned_10504101_OnActorOverlap");
static_assert(offsetof(Summoned_10504101_OnActorOverlap, InActor) == 0x000000, "Member 'Summoned_10504101_OnActorOverlap::InActor' has a wrong offset!");
...
static_assert(alignof(Summoned_10504101_SetMaxHealth) == 0x000004, "Wrong alignment on Summoned_10504101_SetMaxHealth");
static_assert(sizeof(Summoned_10504101_SetMaxHealth) == 0x000004, "Wrong size on Summoned_10504101_SetMaxHealth");
static_assert(offsetof(Summoned_10504101_SetMaxHealth, InMaxHealth) == 0x000000, "Member 'Summoned_10504101_SetMaxHealth::InMaxHealth' has a wrong offset!");
...
static_assert(alignof(Summoned_10504101_GetMaxHealth) == 0x000004, "Wrong alignment on Summoned_10504101_GetMaxHealth");
static_assert(sizeof(Summoned_10504101_GetMaxHealth) == 0x000004, "Wrong size on Summoned_10504101_GetMaxHealth");
static_assert(offsetof(Summoned_10504101_GetMaxHealth, ReturnValue) == 0x000000, "Member 'Summoned_10504101_GetMaxHealth::ReturnValue' has a wrong offset!");
