...
public:
	...
	TDelegate<void(bool bSuccess)>                OnComplete;                                        // 0x0004(0x0014)(BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
