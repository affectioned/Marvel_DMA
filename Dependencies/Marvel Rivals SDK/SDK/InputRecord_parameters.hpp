...
static_assert(alignof(InputRecordComponent_Client_Setting) == 0x000008, "Wrong alignment on InputRecordComponent_Client_Setting");
static_assert(sizeof(InputRecordComponent_Client_Setting) == 0x000028, "Wrong size on InputRecordComponent_Client_Setting");
...
static_assert(alignof(InputRecordComponent_LockFPS) == 0x000008, "Wrong alignment on InputRecordComponent_LockFPS");
static_assert(sizeof(InputRecordComponent_LockFPS) == 0x000010, "Wrong size on InputRecordComponent_LockFPS");
static_assert(offsetof(InputRecordComponent_LockFPS, InFPS) == 0x000000, "Member 'InputRecordComponent_LockFPS::InFPS' has a wrong offset!");
...
static_assert(sizeof(InputRecordComponent_ServerSetActorTransform) == 0x000070, "Wrong size on InputRecordComponent_ServerSetActorTransform");
...
static_assert(offsetof(InputRecordComponent_ServerSetActorTransform, bResetPredictionData) == 0x000060, "Member 'InputRecordComponent_ServerSetActorTransform::bResetPredictionData' has a wrong offset!");
...
static_assert(alignof(InputRecordComponent_ServerSetTargetCharTransform) == 0x000010, "Wrong alignment on InputRecordComponent_ServerSetTargetCharTransform");
static_assert(sizeof(InputRecordComponent_ServerSetTargetCharTransform) == 0x000090, "Wrong size on InputRecordComponent_ServerSetTargetCharTransform");
static_assert(offsetof(InputRecordComponent_ServerSetTargetCharTransform, InContext) == 0x000000, "Member 'InputRecordComponent_ServerSetTargetCharTransform::InContext' has a wrong offset!");
...
static_assert(alignof(InputRecordComponent_SetRecordSetting) == 0x000008, "Wrong alignment on InputRecordComponent_SetRecordSetting");
static_assert(sizeof(InputRecordComponent_SetRecordSetting) == 0x000028, "Wrong size on InputRecordComponent_SetRecordSetting");
...
static_assert(alignof(InputRecordComponent_StopPlayRecord) == 0x000001, "Wrong alignment on InputRecordComponent_StopPlayRecord");
static_assert(sizeof(InputRecordComponent_StopPlayRecord) == 0x000001, "Wrong size on InputRecordComponent_StopPlayRecord");
static_assert(offsetof(InputRecordComponent_StopPlayRecord, bFinishedPlaying) == 0x000000, "Member 'InputRecordComponent_StopPlayRecord::bFinishedPlaying' has a wrong offset!");
...
static_assert(alignof(InputRecordComponent_GetRecordSetting) == 0x000008, "Wrong alignment on InputRecordComponent_GetRecordSetting");
static_assert(sizeof(InputRecordComponent_GetRecordSetting) == 0x000028, "Wrong size on InputRecordComponent_GetRecordSetting");
...
static_assert(alignof(InputRecordComponent_IsLoopPlay) == 0x000001, "Wrong alignment on InputRecordComponent_IsLoopPlay");
static_assert(sizeof(InputRecordComponent_IsLoopPlay) == 0x000001, "Wrong size on InputRecordComponent_IsLoopPlay");
static_assert(offsetof(InputRecordComponent_IsLoopPlay, ReturnValue) == 0x000000, "Member 'InputRecordComponent_IsLoopPlay::ReturnValue' has a wrong offset!");
