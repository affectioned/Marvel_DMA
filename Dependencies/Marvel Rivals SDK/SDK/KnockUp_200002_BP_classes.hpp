...
static_assert(sizeof(UKnockUp_200002_BP_C) == 0x002040, "Wrong size on UKnockUp_200002_BP_C");
static_assert(offsetof(UKnockUp_200002_BP_C, UberGraphFrame) == 0x002038, "Member 'UKnockUp_200002_BP_C::UberGraphFrame' has a wrong offset!");
