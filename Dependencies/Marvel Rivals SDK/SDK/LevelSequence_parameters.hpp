...
static_assert(sizeof(LevelSequenceBurnInOptions_SetBurnIn) == 0x000028, "Wrong size on LevelSequenceBurnInOptions_SetBurnIn");
...
static_assert(alignof(LevelSequenceActor_SetIgnoreNonBoundObjects) == 0x000001, "Wrong alignment on LevelSequenceActor_SetIgnoreNonBoundObjects");
static_assert(sizeof(LevelSequenceActor_SetIgnoreNonBoundObjects) == 0x000001, "Wrong size on LevelSequenceActor_SetIgnoreNonBoundObjects");
static_assert(offsetof(LevelSequenceActor_SetIgnoreNonBoundObjects, bIgnore) == 0x000000, "Member 'LevelSequenceActor_SetIgnoreNonBoundObjects::bIgnore' has a wrong offset!");
