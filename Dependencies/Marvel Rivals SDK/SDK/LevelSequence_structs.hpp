...
static_assert(sizeof(FLevelSequenceAnimSequenceLinkItem) == 0x000040, "Wrong size on FLevelSequenceAnimSequenceLinkItem");
...
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bExportTransforms) == 0x000038, "Member 'FLevelSequenceAnimSequenceLinkItem::bExportTransforms' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bExportMorphTargets) == 0x000039, "Member 'FLevelSequenceAnimSequenceLinkItem::bExportMorphTargets' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bExportAttributeCurves) == 0x00003A, "Member 'FLevelSequenceAnimSequenceLinkItem::bExportAttributeCurves' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bExportMaterialCurves) == 0x00003B, "Member 'FLevelSequenceAnimSequenceLinkItem::bExportMaterialCurves' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, Interpolation) == 0x00003C, "Member 'FLevelSequenceAnimSequenceLinkItem::Interpolation' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, CurveInterpolation) == 0x00003D, "Member 'FLevelSequenceAnimSequenceLinkItem::CurveInterpolation' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bRecordInWorldSpace) == 0x00003E, "Member 'FLevelSequenceAnimSequenceLinkItem::bRecordInWorldSpace' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bEvaluateAllSkeletalMeshComponents) == 0x00003F, "Member 'FLevelSequenceAnimSequenceLinkItem::bEvaluateAllSkeletalMeshComponents' has a wrong offset!");
...
static_assert(sizeof(FLevelSequenceBindingReference) == 0x000048, "Wrong size on FLevelSequenceBindingReference");
...
static_assert(offsetof(FLevelSequenceBindingReference, ObjectPath) == 0x000038, "Member 'FLevelSequenceBindingReference::ObjectPath' has a wrong offset!");
