...
static_assert(sizeof(LiveLinkComponentController_SetSubjectRepresentation) == 0x000018, "Wrong size on LiveLinkComponentController_SetSubjectRepresentation");
...
static_assert(sizeof(LiveLinkComponentController_GetSubjectRepresentation) == 0x000018, "Wrong size on LiveLinkComponentController_GetSubjectRepresentation");
