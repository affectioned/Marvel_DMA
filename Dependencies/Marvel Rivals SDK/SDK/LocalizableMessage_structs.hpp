...
public:
	...
	struct FInstancedStruct                       Value;                                             // 0x0010(0x0028)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FLocalizableMessageParameterEntry) == 0x000008, "Wrong alignment on FLocalizableMessageParameterEntry");
static_assert(sizeof(FLocalizableMessageParameterEntry) == 0x000038, "Wrong size on FLocalizableMessageParameterEntry");
