...
static_assert(alignof(BTD_CheckGameplayTag_OnCheckTagUpdated) == 0x000004, "Wrong alignment on BTD_CheckGameplayTag_OnCheckTagUpdated");
static_assert(sizeof(BTD_CheckGameplayTag_OnCheckTagUpdated) == 0x000010, "Wrong size on BTD_CheckGameplayTag_OnCheckTagUpdated");
static_assert(offsetof(BTD_CheckGameplayTag_OnCheckTagUpdated, InTag) == 0x000000, "Member 'BTD_CheckGameplayTag_OnCheckTagUpdated::InTag' has a wrong offset!");
static_assert(offsetof(BTD_CheckGameplayTag_OnCheckTagUpdated, bExists) == 0x00000C, "Member 'BTD_CheckGameplayTag_OnCheckTagUpdated::bExists' has a wrong offset!");
...
static_assert(alignof(AICliffEdgeNote_GetLookAtTargetLocalPosition) == 0x000008, "Wrong alignment on AICliffEdgeNote_GetLookAtTargetLocalPosition");
static_assert(sizeof(AICliffEdgeNote_GetLookAtTargetLocalPosition) == 0x000018, "Wrong size on AICliffEdgeNote_GetLookAtTargetLocalPosition");
static_assert(offsetof(AICliffEdgeNote_GetLookAtTargetLocalPosition, ReturnValue) == 0x000000, "Member 'AICliffEdgeNote_GetLookAtTargetLocalPosition::ReturnValue' has a wrong offset!");
...
static_assert(alignof(AICliffEdgeNote_GetLookAtTargetPosition) == 0x000008, "Wrong alignment on AICliffEdgeNote_GetLookAtTargetPosition");
static_assert(sizeof(AICliffEdgeNote_GetLookAtTargetPosition) == 0x000018, "Wrong size on AICliffEdgeNote_GetLookAtTargetPosition");
static_assert(offsetof(AICliffEdgeNote_GetLookAtTargetPosition, ReturnValue) == 0x000000, "Member 'AICliffEdgeNote_GetLookAtTargetPosition::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AIAbilityUsageObject_GetUsageConfig) == 0x000270, "Wrong size on AIAbilityUsageObject_GetUsageConfig");
...
static_assert(alignof(AIControllerInfo_IsSyncLeaderPath) == 0x000001, "Wrong alignment on AIControllerInfo_IsSyncLeaderPath");
static_assert(sizeof(AIControllerInfo_IsSyncLeaderPath) == 0x000001, "Wrong size on AIControllerInfo_IsSyncLeaderPath");
static_assert(offsetof(AIControllerInfo_IsSyncLeaderPath, ReturnValue) == 0x000000, "Member 'AIControllerInfo_IsSyncLeaderPath::ReturnValue' has a wrong offset!");
...
static_assert(alignof(AIDebugSubSystem_SetGameplayDebugTarget) == 0x000008, "Wrong alignment on AIDebugSubSystem_SetGameplayDebugTarget");
static_assert(sizeof(AIDebugSubSystem_SetGameplayDebugTarget) == 0x000010, "Wrong size on AIDebugSubSystem_SetGameplayDebugTarget");
static_assert(offsetof(AIDebugSubSystem_SetGameplayDebugTarget, WCO) == 0x000000, "Member 'AIDebugSubSystem_SetGameplayDebugTarget::WCO' has a wrong offset!");
static_assert(offsetof(AIDebugSubSystem_SetGameplayDebugTarget, TargetUID) == 0x000008, "Member 'AIDebugSubSystem_SetGameplayDebugTarget::TargetUID' has a wrong offset!");
...
static_assert(alignof(AIDebugSubSystem_StoreMoveNodeMsg) == 0x000008, "Wrong alignment on AIDebugSubSystem_StoreMoveNodeMsg");
static_assert(sizeof(AIDebugSubSystem_StoreMoveNodeMsg) == 0x000020, "Wrong size on AIDebugSubSystem_StoreMoveNodeMsg");
static_assert(offsetof(AIDebugSubSystem_StoreMoveNodeMsg, WCO) == 0x000000, "Member 'AIDebugSubSystem_StoreMoveNodeMsg::WCO' has a wrong offset!");
static_assert(offsetof(AIDebugSubSystem_StoreMoveNodeMsg, AIController) == 0x000008, "Member 'AIDebugSubSystem_StoreMoveNodeMsg::AIController' has a wrong offset!");
static_assert(offsetof(AIDebugSubSystem_StoreMoveNodeMsg, NodeMsg) == 0x000010, "Member 'AIDebugSubSystem_StoreMoveNodeMsg::NodeMsg' has a wrong offset!");
...
static_assert(alignof(AILabSubSystem_OnAbilityCommitCD) == 0x000008, "Wrong alignment on AILabSubSystem_OnAbilityCommitCD");
static_assert(sizeof(AILabSubSystem_OnAbilityCommitCD) == 0x000010, "Wrong size on AILabSubSystem_OnAbilityCommitCD");
static_assert(offsetof(AILabSubSystem_OnAbilityCommitCD, SourceCharacter) == 0x000000, "Member 'AILabSubSystem_OnAbilityCommitCD::SourceCharacter' has a wrong offset!");
static_assert(offsetof(AILabSubSystem_OnAbilityCommitCD, AbilityID) == 0x000008, "Member 'AILabSubSystem_OnAbilityCommitCD::AbilityID' has a wrong offset!");
static_assert(offsetof(AILabSubSystem_OnAbilityCommitCD, bAddCD) == 0x00000C, "Member 'AILabSubSystem_OnAbilityCommitCD::bAddCD' has a wrong offset!");
...
public:
	class AMarvelAIController*                    AIController;                                      // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAIAbilityUsage                        AbilityUsage;                                      // 0x0008(0x00E8)(ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMarvelProjectileAgentTable            ProjectileAgentTable;                              // 0x00F0(0x1068)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x1158(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AISelectTargetLogicBase_UpdateProjectilePredicateSpeed) == 0x001160, "Wrong size on AISelectTargetLogicBase_UpdateProjectilePredicateSpeed");
...
static_assert(offsetof(AISelectTargetLogicBase_UpdateProjectilePredicateSpeed, ReturnValue) == 0x001158, "Member 'AISelectTargetLogicBase_UpdateProjectilePredicateSpeed::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AIAbilityUsageLibrary_GetUsageConfig) == 0x000358, "Wrong size on AIAbilityUsageLibrary_GetUsageConfig");
...
static_assert(alignof(BTS_DamageStatistics_OnTakingDamage) == 0x000008, "Wrong alignment on BTS_DamageStatistics_OnTakingDamage");
static_assert(sizeof(BTS_DamageStatistics_OnTakingDamage) == 0x000028, "Wrong size on BTS_DamageStatistics_OnTakingDamage");
static_assert(offsetof(BTS_DamageStatistics_OnTakingDamage, InSourceAvatar) == 0x000000, "Member 'BTS_DamageStatistics_OnTakingDamage::InSourceAvatar' has a wrong offset!");
static_assert(offsetof(BTS_DamageStatistics_OnTakingDamage, InTargetAvatar) == 0x000008, "Member 'BTS_DamageStatistics_OnTakingDamage::InTargetAvatar' has a wrong offset!");
static_assert(offsetof(BTS_DamageStatistics_OnTakingDamage, ModifierParameterHandle) == 0x000010, "Member 'BTS_DamageStatistics_OnTakingDamage::ModifierParameterHandle' has a wrong offset!");
...
static_assert(alignof(BTS_UpdatePath_OnLeaderPathUpdate) == 0x000008, "Wrong alignment on BTS_UpdatePath_OnLeaderPathUpdate");
static_assert(sizeof(BTS_UpdatePath_OnLeaderPathUpdate) == 0x0001D0, "Wrong size on BTS_UpdatePath_OnLeaderPathUpdate");
static_assert(offsetof(BTS_UpdatePath_OnLeaderPathUpdate, MoveRequest) == 0x000000, "Member 'BTS_UpdatePath_OnLeaderPathUpdate::MoveRequest' has a wrong offset!");
static_assert(offsetof(BTS_UpdatePath_OnLeaderPathUpdate, NewPath) == 0x000050, "Member 'BTS_UpdatePath_OnLeaderPathUpdate::NewPath' has a wrong offset!");
...
static_assert(sizeof(BTTask_ChaseTarget_OnActorBump) == 0x000218, "Wrong size on BTTask_ChaseTarget_OnActorBump");
...
static_assert(alignof(BTT_GeneralMoveTo_OnForceMoveTaskEnd) == 0x000001, "Wrong alignment on BTT_GeneralMoveTo_OnForceMoveTaskEnd");
static_assert(sizeof(BTT_GeneralMoveTo_OnForceMoveTaskEnd) == 0x000001, "Wrong size on BTT_GeneralMoveTo_OnForceMoveTaskEnd");
static_assert(offsetof(BTT_GeneralMoveTo_OnForceMoveTaskEnd, bSuccess) == 0x000000, "Member 'BTT_GeneralMoveTo_OnForceMoveTaskEnd::bSuccess' has a wrong offset!");
...
static_assert(alignof(BTT_GeneralMoveTo_OnMoveCompleted) == 0x000004, "Wrong alignment on BTT_GeneralMoveTo_OnMoveCompleted");
static_assert(sizeof(BTT_GeneralMoveTo_OnMoveCompleted) == 0x000008, "Wrong size on BTT_GeneralMoveTo_OnMoveCompleted");
static_assert(offsetof(BTT_GeneralMoveTo_OnMoveCompleted, RequestID) == 0x000000, "Member 'BTT_GeneralMoveTo_OnMoveCompleted::RequestID' has a wrong offset!");
static_assert(offsetof(BTT_GeneralMoveTo_OnMoveCompleted, Result) == 0x000004, "Member 'BTT_GeneralMoveTo_OnMoveCompleted::Result' has a wrong offset!");
static_assert(offsetof(BTT_GeneralMoveTo_OnMoveCompleted, Flag) == 0x000006, "Member 'BTT_GeneralMoveTo_OnMoveCompleted::Flag' has a wrong offset!");
...
static_assert(alignof(BTT_TokenGateTemplate_ReceiveExecuteTokenTask) == 0x000008, "Wrong alignment on BTT_TokenGateTemplate_ReceiveExecuteTokenTask");
static_assert(sizeof(BTT_TokenGateTemplate_ReceiveExecuteTokenTask) == 0x000008, "Wrong size on BTT_TokenGateTemplate_ReceiveExecuteTokenTask");
static_assert(offsetof(BTT_TokenGateTemplate_ReceiveExecuteTokenTask, OwnerComp) == 0x000000, "Member 'BTT_TokenGateTemplate_ReceiveExecuteTokenTask::OwnerComp' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_ConsumeRecommendedHeroID) == 0x000004, "Wrong alignment on MarvelAIController_ConsumeRecommendedHeroID");
static_assert(sizeof(MarvelAIController_ConsumeRecommendedHeroID) == 0x000008, "Wrong size on MarvelAIController_ConsumeRecommendedHeroID");
static_assert(offsetof(MarvelAIController_ConsumeRecommendedHeroID, HeroID) == 0x000000, "Member 'MarvelAIController_ConsumeRecommendedHeroID::HeroID' has a wrong offset!");
static_assert(offsetof(MarvelAIController_ConsumeRecommendedHeroID, ReturnValue) == 0x000004, "Member 'MarvelAIController_ConsumeRecommendedHeroID::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_InitNoPSPlayerInfo) == 0x000004, "Wrong alignment on MarvelAIController_InitNoPSPlayerInfo");
static_assert(sizeof(MarvelAIController_InitNoPSPlayerInfo) == 0x000008, "Wrong size on MarvelAIController_InitNoPSPlayerInfo");
static_assert(offsetof(MarvelAIController_InitNoPSPlayerInfo, InTeamID) == 0x000000, "Member 'MarvelAIController_InitNoPSPlayerInfo::InTeamID' has a wrong offset!");
static_assert(offsetof(MarvelAIController_InitNoPSPlayerInfo, InUID) == 0x000004, "Member 'MarvelAIController_InitNoPSPlayerInfo::InUID' has a wrong offset!");
...
public:
	...
	struct FCharacterRebornParam                  RebornParam;                                       // 0x0010(0x0810)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(MarvelAIController_OnPawnReborn) == 0x000010, "Wrong alignment on MarvelAIController_OnPawnReborn");
static_assert(sizeof(MarvelAIController_OnPawnReborn) == 0x000820, "Wrong size on MarvelAIController_OnPawnReborn");
static_assert(offsetof(MarvelAIController_OnPawnReborn, InSourceActor) == 0x000000, "Member 'MarvelAIController_OnPawnReborn::InSourceActor' has a wrong offset!");
static_assert(offsetof(MarvelAIController_OnPawnReborn, RebornParam) == 0x000010, "Member 'MarvelAIController_OnPawnReborn::RebornParam' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_ReceiveRecommendedHeroUpdate) == 0x000004, "Wrong alignment on MarvelAIController_ReceiveRecommendedHeroUpdate");
static_assert(sizeof(MarvelAIController_ReceiveRecommendedHeroUpdate) == 0x000004, "Wrong size on MarvelAIController_ReceiveRecommendedHeroUpdate");
static_assert(offsetof(MarvelAIController_ReceiveRecommendedHeroUpdate, NewRecommendedHeroID) == 0x000000, "Member 'MarvelAIController_ReceiveRecommendedHeroUpdate::NewRecommendedHeroID' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_UpdateRecommendedHeroID) == 0x000004, "Wrong alignment on MarvelAIController_UpdateRecommendedHeroID");
static_assert(sizeof(MarvelAIController_UpdateRecommendedHeroID) == 0x000004, "Wrong size on MarvelAIController_UpdateRecommendedHeroID");
static_assert(offsetof(MarvelAIController_UpdateRecommendedHeroID, HeroID) == 0x000000, "Member 'MarvelAIController_UpdateRecommendedHeroID::HeroID' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_GetDamageFromActor) == 0x000008, "Wrong alignment on MarvelAIController_GetDamageFromActor");
static_assert(sizeof(MarvelAIController_GetDamageFromActor) == 0x000010, "Wrong size on MarvelAIController_GetDamageFromActor");
static_assert(offsetof(MarvelAIController_GetDamageFromActor, Actor) == 0x000000, "Member 'MarvelAIController_GetDamageFromActor::Actor' has a wrong offset!");
static_assert(offsetof(MarvelAIController_GetDamageFromActor, ReturnValue) == 0x000008, "Member 'MarvelAIController_GetDamageFromActor::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_GetHeroID) == 0x000004, "Wrong alignment on MarvelAIController_GetHeroID");
static_assert(sizeof(MarvelAIController_GetHeroID) == 0x000004, "Wrong size on MarvelAIController_GetHeroID");
static_assert(offsetof(MarvelAIController_GetHeroID, ReturnValue) == 0x000000, "Member 'MarvelAIController_GetHeroID::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_GetTeamID) == 0x000004, "Wrong alignment on MarvelAIController_GetTeamID");
static_assert(sizeof(MarvelAIController_GetTeamID) == 0x000004, "Wrong size on MarvelAIController_GetTeamID");
static_assert(offsetof(MarvelAIController_GetTeamID, ReturnValue) == 0x000000, "Member 'MarvelAIController_GetTeamID::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_GetUID) == 0x000004, "Wrong alignment on MarvelAIController_GetUID");
static_assert(sizeof(MarvelAIController_GetUID) == 0x000004, "Wrong size on MarvelAIController_GetUID");
static_assert(offsetof(MarvelAIController_GetUID, ReturnValue) == 0x000000, "Member 'MarvelAIController_GetUID::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_IsAlive) == 0x000001, "Wrong alignment on MarvelAIController_IsAlive");
static_assert(sizeof(MarvelAIController_IsAlive) == 0x000001, "Wrong size on MarvelAIController_IsAlive");
static_assert(offsetof(MarvelAIController_IsAlive, ReturnValue) == 0x000000, "Member 'MarvelAIController_IsAlive::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_IsAutoChangeHeroByAILab) == 0x000001, "Wrong alignment on MarvelAIController_IsAutoChangeHeroByAILab");
static_assert(sizeof(MarvelAIController_IsAutoChangeHeroByAILab) == 0x000001, "Wrong size on MarvelAIController_IsAutoChangeHeroByAILab");
static_assert(offsetof(MarvelAIController_IsAutoChangeHeroByAILab, ReturnValue) == 0x000000, "Member 'MarvelAIController_IsAutoChangeHeroByAILab::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_SetUsageGroupTags) == 0x000008, "Wrong alignment on MarvelAIController_SetUsageGroupTags");
static_assert(sizeof(MarvelAIController_SetUsageGroupTags) == 0x000068, "Wrong size on MarvelAIController_SetUsageGroupTags");
static_assert(offsetof(MarvelAIController_SetUsageGroupTags, NewTags) == 0x000000, "Member 'MarvelAIController_SetUsageGroupTags::NewTags' has a wrong offset!");
...
static_assert(alignof(MarvelAIController_StoreAutoChangeHeroDebugInfo) == 0x000008, "Wrong alignment on MarvelAIController_StoreAutoChangeHeroDebugInfo");
static_assert(sizeof(MarvelAIController_StoreAutoChangeHeroDebugInfo) == 0x000028, "Wrong size on MarvelAIController_StoreAutoChangeHeroDebugInfo");
...
static_assert(offsetof(MarvelAIController_StoreAutoChangeHeroDebugInfo, FailedReason) == 0x000008, "Member 'MarvelAIController_StoreAutoChangeHeroDebugInfo::FailedReason' has a wrong offset!");
static_assert(offsetof(MarvelAIController_StoreAutoChangeHeroDebugInfo, Curve_Energy) == 0x000018, "Member 'MarvelAIController_StoreAutoChangeHeroDebugInfo::Curve_Energy' has a wrong offset!");
static_assert(offsetof(MarvelAIController_StoreAutoChangeHeroDebugInfo, ChangeCD) == 0x00001C, "Member 'MarvelAIController_StoreAutoChangeHeroDebugInfo::ChangeCD' has a wrong offset!");
static_assert(offsetof(MarvelAIController_StoreAutoChangeHeroDebugInfo, Curve_KD) == 0x000020, "Member 'MarvelAIController_StoreAutoChangeHeroDebugInfo::Curve_KD' has a wrong offset!");
...
static_assert(alignof(MarvelAIGlobalDataSubsystem_CanSummonerBeSense) == 0x000004, "Wrong alignment on MarvelAIGlobalDataSubsystem_CanSummonerBeSense");
static_assert(sizeof(MarvelAIGlobalDataSubsystem_CanSummonerBeSense) == 0x000008, "Wrong size on MarvelAIGlobalDataSubsystem_CanSummonerBeSense");
static_assert(offsetof(MarvelAIGlobalDataSubsystem_CanSummonerBeSense, SummonerID) == 0x000000, "Member 'MarvelAIGlobalDataSubsystem_CanSummonerBeSense::SummonerID' has a wrong offset!");
static_assert(offsetof(MarvelAIGlobalDataSubsystem_CanSummonerBeSense, ReturnValue) == 0x000004, "Member 'MarvelAIGlobalDataSubsystem_CanSummonerBeSense::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MarvelAILibrary_ActivateAbilityUsage, bDoUsageCheck) == 0x00003D, "Member 'MarvelAILibrary_ActivateAbilityUsage::bDoUsageCheck' has a wrong offset!");
...
static_assert(sizeof(MarvelAILibrary_GetAbilityIDByConfig) == 0x000280, "Wrong size on MarvelAILibrary_GetAbilityIDByConfig");
...
static_assert(offsetof(MarvelAILibrary_GetAbilityIDByConfig, OwnerController) == 0x000270, "Member 'MarvelAILibrary_GetAbilityIDByConfig::OwnerController' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetAbilityIDByConfig, ReturnValue) == 0x000278, "Member 'MarvelAILibrary_GetAbilityIDByConfig::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MarvelAILibrary_GetAIAutoAbilityConfig) == 0x000278, "Wrong size on MarvelAILibrary_GetAIAutoAbilityConfig");
...
static_assert(alignof(MarvelAILibrary_GetLocOfCoverMostPoints) == 0x000008, "Wrong alignment on MarvelAILibrary_GetLocOfCoverMostPoints");
static_assert(sizeof(MarvelAILibrary_GetLocOfCoverMostPoints) == 0x000048, "Wrong size on MarvelAILibrary_GetLocOfCoverMostPoints");
static_assert(offsetof(MarvelAILibrary_GetLocOfCoverMostPoints, SourcePoints) == 0x000000, "Member 'MarvelAILibrary_GetLocOfCoverMostPoints::SourcePoints' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetLocOfCoverMostPoints, Radius) == 0x000010, "Member 'MarvelAILibrary_GetLocOfCoverMostPoints::Radius' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetLocOfCoverMostPoints, FilterDistanceActor) == 0x000018, "Member 'MarvelAILibrary_GetLocOfCoverMostPoints::FilterDistanceActor' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetLocOfCoverMostPoints, FilterDistance) == 0x000020, "Member 'MarvelAILibrary_GetLocOfCoverMostPoints::FilterDistance' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetLocOfCoverMostPoints, bDebug) == 0x000024, "Member 'MarvelAILibrary_GetLocOfCoverMostPoints::bDebug' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetLocOfCoverMostPoints, DebugShowTime) == 0x000028, "Member 'MarvelAILibrary_GetLocOfCoverMostPoints::DebugShowTime' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetLocOfCoverMostPoints, ReturnValue) == 0x000030, "Member 'MarvelAILibrary_GetLocOfCoverMostPoints::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_GetSummonersByTeam) == 0x000008, "Wrong alignment on MarvelAILibrary_GetSummonersByTeam");
static_assert(sizeof(MarvelAILibrary_GetSummonersByTeam) == 0x000020, "Wrong size on MarvelAILibrary_GetSummonersByTeam");
static_assert(offsetof(MarvelAILibrary_GetSummonersByTeam, WorldContextObject) == 0x000000, "Member 'MarvelAILibrary_GetSummonersByTeam::WorldContextObject' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetSummonersByTeam, TeamID) == 0x000008, "Member 'MarvelAILibrary_GetSummonersByTeam::TeamID' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetSummonersByTeam, OutSummoners) == 0x000010, "Member 'MarvelAILibrary_GetSummonersByTeam::OutSummoners' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_GetSummonersSpawnedFromCharacter) == 0x000008, "Wrong alignment on MarvelAILibrary_GetSummonersSpawnedFromCharacter");
static_assert(sizeof(MarvelAILibrary_GetSummonersSpawnedFromCharacter) == 0x000018, "Wrong size on MarvelAILibrary_GetSummonersSpawnedFromCharacter");
static_assert(offsetof(MarvelAILibrary_GetSummonersSpawnedFromCharacter, InInstigator) == 0x000000, "Member 'MarvelAILibrary_GetSummonersSpawnedFromCharacter::InInstigator' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_GetSummonersSpawnedFromCharacter, OutSummoners) == 0x000008, "Member 'MarvelAILibrary_GetSummonersSpawnedFromCharacter::OutSummoners' has a wrong offset!");
...
static_assert(sizeof(MarvelAILibrary_IsValidAIAutoAbilityConfig) == 0x000278, "Wrong size on MarvelAILibrary_IsValidAIAutoAbilityConfig");
...
static_assert(offsetof(MarvelAILibrary_IsValidAIAutoAbilityConfig, ReturnValue) == 0x000270, "Member 'MarvelAILibrary_IsValidAIAutoAbilityConfig::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_LoadInputRecordByAI) == 0x000008, "Wrong alignment on MarvelAILibrary_LoadInputRecordByAI");
static_assert(sizeof(MarvelAILibrary_LoadInputRecordByAI) == 0x000020, "Wrong size on MarvelAILibrary_LoadInputRecordByAI");
static_assert(offsetof(MarvelAILibrary_LoadInputRecordByAI, InController) == 0x000000, "Member 'MarvelAILibrary_LoadInputRecordByAI::InController' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_LoadInputRecordByAI, RecordName) == 0x000008, "Member 'MarvelAILibrary_LoadInputRecordByAI::RecordName' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_LoadInputRecordByAI, RecordPath) == 0x000018, "Member 'MarvelAILibrary_LoadInputRecordByAI::RecordPath' has a wrong offset!");
...
static_assert(sizeof(MarvelAILibrary_PlayInputRecordByAI) == 0x000008, "Wrong size on MarvelAILibrary_PlayInputRecordByAI");
static_assert(offsetof(MarvelAILibrary_PlayInputRecordByAI, InController) == 0x000000, "Member 'MarvelAILibrary_PlayInputRecordByAI::InController' has a wrong offset!");
...
static_assert(sizeof(MarvelAILibrary_SetAIChangeHeroDebugInfo) == 0x000028, "Wrong size on MarvelAILibrary_SetAIChangeHeroDebugInfo");
...
static_assert(offsetof(MarvelAILibrary_SetAIChangeHeroDebugInfo, FailedReason) == 0x000018, "Member 'MarvelAILibrary_SetAIChangeHeroDebugInfo::FailedReason' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_SetDDADramaType) == 0x000008, "Wrong alignment on MarvelAILibrary_SetDDADramaType");
static_assert(sizeof(MarvelAILibrary_SetDDADramaType) == 0x000010, "Wrong size on MarvelAILibrary_SetDDADramaType");
static_assert(offsetof(MarvelAILibrary_SetDDADramaType, WorldContextObject) == 0x000000, "Member 'MarvelAILibrary_SetDDADramaType::WorldContextObject' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_SetDDADramaType, DDAType) == 0x000008, "Member 'MarvelAILibrary_SetDDADramaType::DDAType' has a wrong offset!");
...
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAISpawnParam                          AISpawnParam;                                      // 0x0008(0x00C0)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	class AAIController*                          ReturnValue;                                       // 0x00C8(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MarvelAILibrary_SpawnInputRecordByAI) == 0x000008, "Wrong alignment on MarvelAILibrary_SpawnInputRecordByAI");
static_assert(sizeof(MarvelAILibrary_SpawnInputRecordByAI) == 0x0000D0, "Wrong size on MarvelAILibrary_SpawnInputRecordByAI");
static_assert(offsetof(MarvelAILibrary_SpawnInputRecordByAI, WorldContextObject) == 0x000000, "Member 'MarvelAILibrary_SpawnInputRecordByAI::WorldContextObject' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_SpawnInputRecordByAI, AISpawnParam) == 0x000008, "Member 'MarvelAILibrary_SpawnInputRecordByAI::AISpawnParam' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_SpawnInputRecordByAI, ReturnValue) == 0x0000C8, "Member 'MarvelAILibrary_SpawnInputRecordByAI::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_UpdateAIDifficultyByTeamID) == 0x000008, "Wrong alignment on MarvelAILibrary_UpdateAIDifficultyByTeamID");
static_assert(sizeof(MarvelAILibrary_UpdateAIDifficultyByTeamID) == 0x000010, "Wrong size on MarvelAILibrary_UpdateAIDifficultyByTeamID");
static_assert(offsetof(MarvelAILibrary_UpdateAIDifficultyByTeamID, WorldContextObject) == 0x000000, "Member 'MarvelAILibrary_UpdateAIDifficultyByTeamID::WorldContextObject' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_UpdateAIDifficultyByTeamID, TeamID) == 0x000008, "Member 'MarvelAILibrary_UpdateAIDifficultyByTeamID::TeamID' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_UpdateAIDifficultyByTeamID, DifficultyLevel) == 0x00000C, "Member 'MarvelAILibrary_UpdateAIDifficultyByTeamID::DifficultyLevel' has a wrong offset!");
...
static_assert(alignof(MarvelAILibrary_VisibleCheckForBattleChess) == 0x000008, "Wrong alignment on MarvelAILibrary_VisibleCheckForBattleChess");
static_assert(sizeof(MarvelAILibrary_VisibleCheckForBattleChess) == 0x000018, "Wrong size on MarvelAILibrary_VisibleCheckForBattleChess");
static_assert(offsetof(MarvelAILibrary_VisibleCheckForBattleChess, Querier) == 0x000000, "Member 'MarvelAILibrary_VisibleCheckForBattleChess::Querier' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_VisibleCheckForBattleChess, Target) == 0x000008, "Member 'MarvelAILibrary_VisibleCheckForBattleChess::Target' has a wrong offset!");
static_assert(offsetof(MarvelAILibrary_VisibleCheckForBattleChess, ReturnValue) == 0x000010, "Member 'MarvelAILibrary_VisibleCheckForBattleChess::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MarvelAIStimuliSourceComponent_WhenOwnerReborn) == 0x000820, "Wrong size on MarvelAIStimuliSourceComponent_WhenOwnerReborn");
...
{
public:
	struct FAISpawnParam                          SpawnParam;                                        // 0x0000(0x00C0)(Parm, NativeAccessSpecifierPublic)
	class AMarvelAIController*                    ReturnValue;                                       // 0x00C0(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MarvelAISystem_AddAICustom) == 0x000008, "Wrong alignment on MarvelAISystem_AddAICustom");
static_assert(sizeof(MarvelAISystem_AddAICustom) == 0x0000C8, "Wrong size on MarvelAISystem_AddAICustom");
...
static_assert(offsetof(MarvelAISystem_AddAICustom, ReturnValue) == 0x0000C0, "Member 'MarvelAISystem_AddAICustom::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MarvelAISystem_RegisterNewAI) == 0x000010, "Wrong size on MarvelAISystem_RegisterNewAI");
...
static_assert(offsetof(MarvelAISystem_RegisterNewAI, UID) == 0x000008, "Member 'MarvelAISystem_RegisterNewAI::UID' has a wrong offset!");
...
static_assert(alignof(MarvelAISystem_RemoveInputRecordAI) == 0x000010, "Wrong alignment on MarvelAISystem_RemoveInputRecordAI");
static_assert(sizeof(MarvelAISystem_RemoveInputRecordAI) == 0x000100, "Wrong size on MarvelAISystem_RemoveInputRecordAI");
static_assert(offsetof(MarvelAISystem_RemoveInputRecordAI, InTestContext) == 0x000000, "Member 'MarvelAISystem_RemoveInputRecordAI::InTestContext' has a wrong offset!");
static_assert(offsetof(MarvelAISystem_RemoveInputRecordAI, bFinishedPlaying) == 0x0000F0, "Member 'MarvelAISystem_RemoveInputRecordAI::bFinishedPlaying' has a wrong offset!");
...
static_assert(alignof(MarvelAITeamManager_LevelCheckHeroSelectable) == 0x000008, "Wrong alignment on MarvelAITeamManager_LevelCheckHeroSelectable");
static_assert(sizeof(MarvelAITeamManager_LevelCheckHeroSelectable) == 0x000010, "Wrong size on MarvelAITeamManager_LevelCheckHeroSelectable");
static_assert(offsetof(MarvelAITeamManager_LevelCheckHeroSelectable, PlayerState) == 0x000000, "Member 'MarvelAITeamManager_LevelCheckHeroSelectable::PlayerState' has a wrong offset!");
static_assert(offsetof(MarvelAITeamManager_LevelCheckHeroSelectable, HeroID) == 0x000008, "Member 'MarvelAITeamManager_LevelCheckHeroSelectable::HeroID' has a wrong offset!");
static_assert(offsetof(MarvelAITeamManager_LevelCheckHeroSelectable, ReturnValue) == 0x00000C, "Member 'MarvelAITeamManager_LevelCheckHeroSelectable::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MarvelNavigationSystem_OnLevelPortalActivated) == 0x000008, "Wrong alignment on MarvelNavigationSystem_OnLevelPortalActivated");
static_assert(sizeof(MarvelNavigationSystem_OnLevelPortalActivated) == 0x000010, "Wrong size on MarvelNavigationSystem_OnLevelPortalActivated");
static_assert(offsetof(MarvelNavigationSystem_OnLevelPortalActivated, Portal) == 0x000000, "Member 'MarvelNavigationSystem_OnLevelPortalActivated::Portal' has a wrong offset!");
static_assert(offsetof(MarvelNavigationSystem_OnLevelPortalActivated, bActivated) == 0x000008, "Member 'MarvelNavigationSystem_OnLevelPortalActivated::bActivated' has a wrong offset!");
...
static_assert(alignof(MarvelNavModifierComponent_K2_UpdateNavEffect) == 0x000001, "Wrong alignment on MarvelNavModifierComponent_K2_UpdateNavEffect");
static_assert(sizeof(MarvelNavModifierComponent_K2_UpdateNavEffect) == 0x000001, "Wrong size on MarvelNavModifierComponent_K2_UpdateNavEffect");
static_assert(offsetof(MarvelNavModifierComponent_K2_UpdateNavEffect, bEffectNav) == 0x000000, "Member 'MarvelNavModifierComponent_K2_UpdateNavEffect::bEffectNav' has a wrong offset!");
...
static_assert(alignof(MarvelPathFollowingComponent_SetMoveInputScale) == 0x000004, "Wrong alignment on MarvelPathFollowingComponent_SetMoveInputScale");
static_assert(sizeof(MarvelPathFollowingComponent_SetMoveInputScale) == 0x000004, "Wrong size on MarvelPathFollowingComponent_SetMoveInputScale");
static_assert(offsetof(MarvelPathFollowingComponent_SetMoveInputScale, Scale) == 0x000000, "Member 'MarvelPathFollowingComponent_SetMoveInputScale::Scale' has a wrong offset!");
