...
public:
	...
	struct FAILabProtoAbilityData                 AbilityUsageData;                                  // 0x0080(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FAILabProtoEnvironmentData             EnvironmentData;                                   // 0x0170(0x0040)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FAILabProtoWeaponClipData              WeaponClip;                                        // 0x01B0(0x001C)(NoDestructor, NativeAccessSpecifierPublic)
	struct FAILabProtoBattleRecordData            BattleRecordBoard;                                 // 0x01CC(0x001C)(NoDestructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 CurrentAmmoTypes;                                  // 0x01E8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         AllyTargetUID;                                     // 0x01F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         EnemyTargetUID;                                    // 0x01FC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TeamID;                                            // 0x0200(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        UsageGroupFlag;                                    // 0x0204(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          WantChangeHero;                                    // 0x0208(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
