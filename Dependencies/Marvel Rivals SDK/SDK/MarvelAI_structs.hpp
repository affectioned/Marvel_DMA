...
static_assert(sizeof(FTacticsTaskParam) == 0x0000D8, "Wrong size on FTacticsTaskParam");
static_assert(offsetof(FTacticsTaskParam, TaskOwner) == 0x000008, "Member 'FTacticsTaskParam::TaskOwner' has a wrong offset!");
static_assert(offsetof(FTacticsTaskParam, OverrideSelectCheckClass) == 0x0000D0, "Member 'FTacticsTaskParam::OverrideSelectCheckClass' has a wrong offset!");
...
static_assert(alignof(FNavPathWrapper) == 0x000008, "Wrong alignment on FNavPathWrapper");
static_assert(sizeof(FNavPathWrapper) == 0x000180, "Wrong size on FNavPathWrapper");
...
static_assert(sizeof(FAbilityTacticsRequest) == 0x0000E0, "Wrong size on FAbilityTacticsRequest");
...
static_assert(alignof(FAIChangeHeroDebugInfo) == 0x000008, "Wrong alignment on FAIChangeHeroDebugInfo");
static_assert(sizeof(FAIChangeHeroDebugInfo) == 0x000020, "Wrong size on FAIChangeHeroDebugInfo");
...
static_assert(offsetof(FAIServerResponseProtocol, RecommendedHeroID) == 0x000018, "Member 'FAIServerResponseProtocol::RecommendedHeroID' has a wrong offset!");
static_assert(offsetof(FAIServerResponseProtocol, ShouldAvoidBattle) == 0x00001C, "Member 'FAIServerResponseProtocol::ShouldAvoidBattle' has a wrong offset!");
...
public:
	...
	int32                                         TeamID;                                            // 0x01B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        UsageGroupFlag;                                    // 0x01B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          WantChangeHero;                                    // 0x01B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAILabProtoCharacterData) == 0x0001C0, "Wrong size on FAILabProtoCharacterData");
...
static_assert(offsetof(FAILabProtoCharacterData, TeamID) == 0x0001B0, "Member 'FAILabProtoCharacterData::TeamID' has a wrong offset!");
static_assert(offsetof(FAILabProtoCharacterData, UsageGroupFlag) == 0x0001B4, "Member 'FAILabProtoCharacterData::UsageGroupFlag' has a wrong offset!");
static_assert(offsetof(FAILabProtoCharacterData, WantChangeHero) == 0x0001B8, "Member 'FAILabProtoCharacterData::WantChangeHero' has a wrong offset!");
...
static_assert(alignof(FSelectTargetQueryContext) == 0x000008, "Wrong alignment on FSelectTargetQueryContext");
static_assert(sizeof(FSelectTargetQueryContext) == 0x000010, "Wrong size on FSelectTargetQueryContext");
static_assert(offsetof(FSelectTargetQueryContext, GameStateCache) == 0x000000, "Member 'FSelectTargetQueryContext::GameStateCache' has a wrong offset!");
...
static_assert(alignof(FPlay2DEmojiConfig) == 0x000008, "Wrong alignment on FPlay2DEmojiConfig");
static_assert(sizeof(FPlay2DEmojiConfig) == 0x000018, "Wrong size on FPlay2DEmojiConfig");
static_assert(offsetof(FPlay2DEmojiConfig, Combat2DEmojiID) == 0x000000, "Member 'FPlay2DEmojiConfig::Combat2DEmojiID' has a wrong offset!");
static_assert(offsetof(FPlay2DEmojiConfig, UseWeight) == 0x000010, "Member 'FPlay2DEmojiConfig::UseWeight' has a wrong offset!");
...
static_assert(alignof(FVisionConfig) == 0x000004, "Wrong alignment on FVisionConfig");
static_assert(sizeof(FVisionConfig) == 0x000008, "Wrong size on FVisionConfig");
static_assert(offsetof(FVisionConfig, VisionRadius) == 0x000000, "Member 'FVisionConfig::VisionRadius' has a wrong offset!");
static_assert(offsetof(FVisionConfig, VisionRadiusForDamageSource) == 0x000004, "Member 'FVisionConfig::VisionRadiusForDamageSource' has a wrong offset!");
...
public:
	...
	int32                                         ActiveMinHeight;                                   // 0x0010(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCheckSelfHeight;                                  // 0x0014(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRange_Int32Value                      ActiveSelfHeight;                                  // 0x0018(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	float                                         ChanceToUse;                                       // 0x0020(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOnlyUseWhenTakingDamage;                          // 0x0024(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInt32Range                            NumOfEnemiesInView;                                // 0x0028(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInt32Range                            NumOfTeammatesInView;                              // 0x0038(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInt32Range                            NearbyDeaths;                                      // 0x0048(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInt32Range                            NearbyEnemyDeaths;                                 // 0x0058(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInt32Range                            NearbyAllyDeaths;                                  // 0x0068(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	MarvelAI::ETargetType                         TargetType;                                        // 0x0078(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTryTargetFromSelectLogic;                         // 0x0079(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsVisible;                                        // 0x007A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7B[0x1];                                       // 0x007B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRange_FloatValue                      TargetHealth;                                      // 0x007C(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bNeedCheckTeamHealth;                              // 0x0084(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_85[0x3];                                       // 0x0085(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GroupHealth;                                       // 0x0088(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLowHealthConfig                       LowHealth;                                         // 0x008C(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAIAbilityConditionConfig) == 0x000004, "Wrong alignment on FAIAbilityConditionConfig");
static_assert(sizeof(FAIAbilityConditionConfig) == 0x000094, "Wrong size on FAIAbilityConditionConfig");
...
static_assert(offsetof(FAIAbilityConditionConfig, ActiveMinHeight) == 0x000010, "Member 'FAIAbilityConditionConfig::ActiveMinHeight' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, bCheckSelfHeight) == 0x000014, "Member 'FAIAbilityConditionConfig::bCheckSelfHeight' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, ActiveSelfHeight) == 0x000018, "Member 'FAIAbilityConditionConfig::ActiveSelfHeight' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, ChanceToUse) == 0x000020, "Member 'FAIAbilityConditionConfig::ChanceToUse' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, bOnlyUseWhenTakingDamage) == 0x000024, "Member 'FAIAbilityConditionConfig::bOnlyUseWhenTakingDamage' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, NumOfEnemiesInView) == 0x000028, "Member 'FAIAbilityConditionConfig::NumOfEnemiesInView' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, NumOfTeammatesInView) == 0x000038, "Member 'FAIAbilityConditionConfig::NumOfTeammatesInView' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, NearbyDeaths) == 0x000048, "Member 'FAIAbilityConditionConfig::NearbyDeaths' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, NearbyEnemyDeaths) == 0x000058, "Member 'FAIAbilityConditionConfig::NearbyEnemyDeaths' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, NearbyAllyDeaths) == 0x000068, "Member 'FAIAbilityConditionConfig::NearbyAllyDeaths' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, TargetType) == 0x000078, "Member 'FAIAbilityConditionConfig::TargetType' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, bTryTargetFromSelectLogic) == 0x000079, "Member 'FAIAbilityConditionConfig::bTryTargetFromSelectLogic' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, bIsVisible) == 0x00007A, "Member 'FAIAbilityConditionConfig::bIsVisible' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, TargetHealth) == 0x00007C, "Member 'FAIAbilityConditionConfig::TargetHealth' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, bNeedCheckTeamHealth) == 0x000084, "Member 'FAIAbilityConditionConfig::bNeedCheckTeamHealth' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, GroupHealth) == 0x000088, "Member 'FAIAbilityConditionConfig::GroupHealth' has a wrong offset!");
static_assert(offsetof(FAIAbilityConditionConfig, LowHealth) == 0x00008C, "Member 'FAIAbilityConditionConfig::LowHealth' has a wrong offset!");
...
public:
	...
	struct FAIAbilityConditionConfig              ConditionConfig;                                   // 0x01A0(0x0094)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	float                                         PriorityScore;                                     // 0x0234(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FComboConfig                           ComboConfig;                                       // 0x0238(0x0008)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	EAbilityCheckType                             AbilityCheckType;                                  // 0x0240(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_241[0x7];                                      // 0x0241(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAIAbilityButtonActivationConfig> ButtonConfig;                                    // 0x0248(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bHasCancelButton;                                  // 0x0258(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAbilityInputBinds                            CancelButton;                                      // 0x0259(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_25A[0x6];                                      // 0x025A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UAIAbilityFlowCheckLogicBase> FlowCheckLogic;                                  // 0x0260(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAIAbilityUsageAsset*                   UsageAsset;                                        // 0x0268(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMarvelAIAutoAbilityTable) == 0x000008, "Wrong alignment on FMarvelAIAutoAbilityTable");
static_assert(sizeof(FMarvelAIAutoAbilityTable) == 0x000270, "Wrong size on FMarvelAIAutoAbilityTable");
...
static_assert(offsetof(FMarvelAIAutoAbilityTable, PriorityScore) == 0x000234, "Member 'FMarvelAIAutoAbilityTable::PriorityScore' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, ComboConfig) == 0x000238, "Member 'FMarvelAIAutoAbilityTable::ComboConfig' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, AbilityCheckType) == 0x000240, "Member 'FMarvelAIAutoAbilityTable::AbilityCheckType' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, ButtonConfig) == 0x000248, "Member 'FMarvelAIAutoAbilityTable::ButtonConfig' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, bHasCancelButton) == 0x000258, "Member 'FMarvelAIAutoAbilityTable::bHasCancelButton' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, CancelButton) == 0x000259, "Member 'FMarvelAIAutoAbilityTable::CancelButton' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, FlowCheckLogic) == 0x000260, "Member 'FMarvelAIAutoAbilityTable::FlowCheckLogic' has a wrong offset!");
static_assert(offsetof(FMarvelAIAutoAbilityTable, UsageAsset) == 0x000268, "Member 'FMarvelAIAutoAbilityTable::UsageAsset' has a wrong offset!");
...
static_assert(alignof(FAIChangeHeroModeConfig) == 0x000008, "Wrong alignment on FAIChangeHeroModeConfig");
static_assert(sizeof(FAIChangeHeroModeConfig) == 0x000020, "Wrong size on FAIChangeHeroModeConfig");
static_assert(offsetof(FAIChangeHeroModeConfig, EnergyCurve) == 0x000000, "Member 'FAIChangeHeroModeConfig::EnergyCurve' has a wrong offset!");
static_assert(offsetof(FAIChangeHeroModeConfig, KillDeathCurve) == 0x000008, "Member 'FAIChangeHeroModeConfig::KillDeathCurve' has a wrong offset!");
static_assert(offsetof(FAIChangeHeroModeConfig, ChangeHeroCD) == 0x000010, "Member 'FAIChangeHeroModeConfig::ChangeHeroCD' has a wrong offset!");
static_assert(offsetof(FAIChangeHeroModeConfig, DeathThreshold) == 0x000014, "Member 'FAIChangeHeroModeConfig::DeathThreshold' has a wrong offset!");
static_assert(offsetof(FAIChangeHeroModeConfig, BuildBondPossibility) == 0x000018, "Member 'FAIChangeHeroModeConfig::BuildBondPossibility' has a wrong offset!");
...
{
public:
	struct FAIChangeHeroModeConfig                ChangeHeroModeConfig;                              // 0x0000(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	TArray<struct FAIRolePriority>                RolePriorityList;                                  // 0x0020(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FRange_FloatValue                      PreselectTimeRange;                                // 0x0030(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FRange_FloatValue                      UpdateDelayRange;                                  // 0x0038(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	TSet<int32>                                   BlackListPlayerTeam;                               // 0x0040(0x0050)(Edit, NativeAccessSpecifierPublic)
	TSet<int32>                                   BlackListAITeam;                                   // 0x0090(0x0050)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAIChangeHeroConfig) == 0x000008, "Wrong alignment on FAIChangeHeroConfig");
static_assert(sizeof(FAIChangeHeroConfig) == 0x0000E0, "Wrong size on FAIChangeHeroConfig");
static_assert(offsetof(FAIChangeHeroConfig, ChangeHeroModeConfig) == 0x000000, "Member 'FAIChangeHeroConfig::ChangeHeroModeConfig' has a wrong offset!");
static_assert(offsetof(FAIChangeHeroConfig, RolePriorityList) == 0x000020, "Member 'FAIChangeHeroConfig::RolePriorityList' has a wrong offset!");
static_assert(offsetof(FAIChangeHeroConfig, PreselectTimeRange) == 0x000030, "Member 'FAIChangeHeroConfig::PreselectTimeRange' has a wrong offset!");
static_assert(offsetof(FAIChangeHeroConfig, UpdateDelayRange) == 0x000038, "Member 'FAIChangeHeroConfig::UpdateDelayRange' has a wrong offset!");
static_assert(offsetof(FAIChangeHeroConfig, BlackListPlayerTeam) == 0x000040, "Member 'FAIChangeHeroConfig::BlackListPlayerTeam' has a wrong offset!");
static_assert(offsetof(FAIChangeHeroConfig, BlackListAITeam) == 0x000090, "Member 'FAIChangeHeroConfig::BlackListAITeam' has a wrong offset!");
...
public:
	...
	class UBehaviorTree*                          GameModeDefaultBTree;                              // 0x00C0(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         DefaultRequestServerIndex;                         // 0x00C8(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AllowAIChangeHero;                                 // 0x00CC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ChangeHeroByAILab;                                 // 0x00CD(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bNeedOverrideChangeModeConfig;                     // 0x00CE(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_CF[0x1];                                       // 0x00CF(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAIChangeHeroModeConfig                OverrideChangeHeroModeConfig;                      // 0x00D0(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAIGameModeConfig) == 0x000008, "Wrong alignment on FAIGameModeConfig");
static_assert(sizeof(FAIGameModeConfig) == 0x0000F0, "Wrong size on FAIGameModeConfig");
...
static_assert(offsetof(FAIGameModeConfig, HeroBlackList) == 0x000058, "Member 'FAIGameModeConfig::HeroBlackList' has a wrong offset!");
static_assert(offsetof(FAIGameModeConfig, UseDefaultLineupPriority) == 0x0000A8, "Member 'FAIGameModeConfig::UseDefaultLineupPriority' has a wrong offset!");
static_assert(offsetof(FAIGameModeConfig, RolePriorityList) == 0x0000B0, "Member 'FAIGameModeConfig::RolePriorityList' has a wrong offset!");
static_assert(offsetof(FAIGameModeConfig, GameModeDefaultBTree) == 0x0000C0, "Member 'FAIGameModeConfig::GameModeDefaultBTree' has a wrong offset!");
static_assert(offsetof(FAIGameModeConfig, DefaultRequestServerIndex) == 0x0000C8, "Member 'FAIGameModeConfig::DefaultRequestServerIndex' has a wrong offset!");
static_assert(offsetof(FAIGameModeConfig, AllowAIChangeHero) == 0x0000CC, "Member 'FAIGameModeConfig::AllowAIChangeHero' has a wrong offset!");
static_assert(offsetof(FAIGameModeConfig, ChangeHeroByAILab) == 0x0000CD, "Member 'FAIGameModeConfig::ChangeHeroByAILab' has a wrong offset!");
static_assert(offsetof(FAIGameModeConfig, bNeedOverrideChangeModeConfig) == 0x0000CE, "Member 'FAIGameModeConfig::bNeedOverrideChangeModeConfig' has a wrong offset!");
static_assert(offsetof(FAIGameModeConfig, OverrideChangeHeroModeConfig) == 0x0000D0, "Member 'FAIGameModeConfig::OverrideChangeHeroModeConfig' has a wrong offset!");
...
static_assert(alignof(FAITokenPool) == 0x000008, "Wrong alignment on FAITokenPool");
static_assert(sizeof(FAITokenPool) == 0x000058, "Wrong size on FAITokenPool");
...
static_assert(sizeof(FAISpawnParam) == 0x0000C0, "Wrong size on FAISpawnParam");
...
static_assert(offsetof(FAISpawnParam, SkinSlots) == 0x0000A8, "Member 'FAISpawnParam::SkinSlots' has a wrong offset!");
static_assert(offsetof(FAISpawnParam, ControllerClass) == 0x0000B8, "Member 'FAISpawnParam::ControllerClass' has a wrong offset!");
