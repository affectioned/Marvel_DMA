...
{
public:
	struct FGameplayTagContainer                  UserTags;                                          // 0x0000(0x0068)(Transient, NativeAccessSpecifierPublic)
	struct FSmartObjectClaimHandle                InteractionHandle;                                 // 0x0068(0x0020)(Transient, NoDestructor, NativeAccessSpecifierPublic)
	EMassSmartObjectInteractionStatus             InteractionStatus;                                 // 0x0088(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
