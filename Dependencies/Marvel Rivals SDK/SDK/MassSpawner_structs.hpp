...
{
public:
	struct FInstancedStruct                       SpawnData;                                         // 0x0000(0x0028)(NativeAccessSpecifierPublic)
	TSubclassOf<class UMassProcessor>             SpawnDataProcessor;                                // 0x0028(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<TSubclassOf<class UMassProcessor>>     PostSpawnProcessors;                               // 0x0030(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
