...
// Function MediaAssets.MediaPlayer.GetErrorReason
// 0x0010 (0x0010 - 0x0000)
struct MediaPlayer_GetErrorReason final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaPlayer_GetErrorReason) == 0x000008, "Wrong alignment on MediaPlayer_GetErrorReason");
static_assert(sizeof(MediaPlayer_GetErrorReason) == 0x000010, "Wrong size on MediaPlayer_GetErrorReason");
static_assert(offsetof(MediaPlayer_GetErrorReason, ReturnValue) == 0x000000, "Member 'MediaPlayer_GetErrorReason::ReturnValue' has a wrong offset!");
