...
static_assert(sizeof(FSimulationStageMetaData) == 0x0000C8, "Wrong size on FSimulationStageMetaData");
...
static_assert(offsetof(FSimulationStageMetaData, EnabledBinding) == 0x00000C, "Member 'FSimulationStageMetaData::EnabledBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ElementCount) == 0x000018, "Member 'FSimulationStageMetaData::ElementCount' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ElementCountXBinding) == 0x000024, "Member 'FSimulationStageMetaData::ElementCountXBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ElementCountYBinding) == 0x000030, "Member 'FSimulationStageMetaData::ElementCountYBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ElementCountZBinding) == 0x00003C, "Member 'FSimulationStageMetaData::ElementCountZBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, IterationSourceType) == 0x000048, "Member 'FSimulationStageMetaData::IterationSourceType' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, IterationDataInterface) == 0x00004C, "Member 'FSimulationStageMetaData::IterationDataInterface' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, IterationDirectBinding) == 0x000058, "Member 'FSimulationStageMetaData::IterationDirectBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ExecuteBehavior) == 0x000064, "Member 'FSimulationStageMetaData::ExecuteBehavior' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ParticleIterationStateBinding) == 0x00006C, "Member 'FSimulationStageMetaData::ParticleIterationStateBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ParticleIterationStateRange) == 0x00007C, "Member 'FSimulationStageMetaData::ParticleIterationStateRange' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, OutputDestinations) == 0x000088, "Member 'FSimulationStageMetaData::OutputDestinations' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, InputDataInterfaces) == 0x000098, "Member 'FSimulationStageMetaData::InputDataInterfaces' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, NumIterations) == 0x0000A8, "Member 'FSimulationStageMetaData::NumIterations' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, NumIterationsBinding) == 0x0000AC, "Member 'FSimulationStageMetaData::NumIterationsBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, GpuDispatchType) == 0x0000B8, "Member 'FSimulationStageMetaData::GpuDispatchType' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, GpuDirectDispatchElementType) == 0x0000B9, "Member 'FSimulationStageMetaData::GpuDirectDispatchElementType' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, GpuDispatchNumThreads) == 0x0000BC, "Member 'FSimulationStageMetaData::GpuDispatchNumThreads' has a wrong offset!");
...
static_assert(sizeof(FNiagaraDataInterfaceGeneratedFunction) == 0x000058, "Wrong size on FNiagaraDataInterfaceGeneratedFunction");
static_assert(offsetof(FNiagaraDataInterfaceGeneratedFunction, VariadicInputs) == 0x000038, "Member 'FNiagaraDataInterfaceGeneratedFunction::VariadicInputs' has a wrong offset!");
static_assert(offsetof(FNiagaraDataInterfaceGeneratedFunction, VariadicOutputs) == 0x000048, "Member 'FNiagaraDataInterfaceGeneratedFunction::VariadicOutputs' has a wrong offset!");
...
static_assert(sizeof(FNiagaraShaderScriptExternalConstant) == 0x000020, "Wrong size on FNiagaraShaderScriptExternalConstant");
...
static_assert(offsetof(FNiagaraShaderScriptExternalConstant, Name) == 0x000010, "Member 'FNiagaraShaderScriptExternalConstant::Name' has a wrong offset!");
