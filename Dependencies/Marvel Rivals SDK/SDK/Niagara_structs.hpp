...
public:
	...
	class UNiagaraParameterCollectionInstance*    ParameterCollectionOverride;                       // 0x0090(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraSystemSpawnParameters) == 0x000008, "Wrong alignment on FNiagaraSystemSpawnParameters");
static_assert(sizeof(FNiagaraSystemSpawnParameters) == 0x000098, "Wrong size on FNiagaraSystemSpawnParameters");
static_assert(offsetof(FNiagaraSystemSpawnParameters, ParameterCollectionOverride) == 0x000090, "Member 'FNiagaraSystemSpawnParameters::ParameterCollectionOverride' has a wrong offset!");
...
public:
	...
	float                                         LastDesiredAge;                                    // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FMovieSceneNiagaraSystemTrackImplementation) == 0x000030, "Wrong size on FMovieSceneNiagaraSystemTrackImplementation");
...
static_assert(offsetof(FMovieSceneNiagaraSystemTrackImplementation, LastDesiredAge) == 0x000028, "Member 'FMovieSceneNiagaraSystemTrackImplementation::LastDesiredAge' has a wrong offset!");
...
public:
	...
	bool                                          bInitLowestMask;                                   // 0x0024(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FNiagaraPlatformSet, bInitLowestMask) == 0x000024, "Member 'FNiagaraPlatformSet::bInitLowestMask' has a wrong offset!");
...
public:
	...
	bool                                          bIgnoreDistanceCulledScalability;                  // 0x00E4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E5[0x3];                                       // 0x00E5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxGPUParticlesSpawnPerFrame;                      // 0x00E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bUpdateLoopEffectFlag;                             // 0x00F4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsLoopEffect;                                     // 0x00F5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FNiagaraParameterStore                 RendererBindings;                                  // 0x0148(0x0090)(NativeAccessSpecifierPublic)
	TArray<struct FNiagaraExternalUObjectInfo>    RendererBindingsExternalObjects;                   // 0x01D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<struct FNiagaraVariableBase, struct FNiagaraVariableBase> ResolvedDIBindings;               // 0x01E8(0x0050)(NativeAccessSpecifierPublic)
	TArray<class UNiagaraRendererProperties*>     RendererProperties;                                // 0x0238(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraSimulationStageBase*>    SimulationStages;                                  // 0x0248(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FVersionedNiagaraEmitterData) == 0x000348, "Wrong size on FVersionedNiagaraEmitterData");
...
static_assert(offsetof(FVersionedNiagaraEmitterData, bIgnoreDistanceCulledScalability) == 0x0000E4, "Member 'FVersionedNiagaraEmitterData::bIgnoreDistanceCulledScalability' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, MaxGPUParticlesSpawnPerFrame) == 0x0000E8, "Member 'FVersionedNiagaraEmitterData::MaxGPUParticlesSpawnPerFrame' has a wrong offset!");
...
static_assert(offsetof(FVersionedNiagaraEmitterData, bUpdateLoopEffectFlag) == 0x0000F4, "Member 'FVersionedNiagaraEmitterData::bUpdateLoopEffectFlag' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, bIsLoopEffect) == 0x0000F5, "Member 'FVersionedNiagaraEmitterData::bIsLoopEffect' has a wrong offset!");
...
static_assert(offsetof(FVersionedNiagaraEmitterData, RendererBindingsExternalObjects) == 0x0001D8, "Member 'FVersionedNiagaraEmitterData::RendererBindingsExternalObjects' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, ResolvedDIBindings) == 0x0001E8, "Member 'FVersionedNiagaraEmitterData::ResolvedDIBindings' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, RendererProperties) == 0x000238, "Member 'FVersionedNiagaraEmitterData::RendererProperties' has a wrong offset!");
static_assert(offsetof(FVersionedNiagaraEmitterData, SimulationStages) == 0x000248, "Member 'FVersionedNiagaraEmitterData::SimulationStages' has a wrong offset!");
