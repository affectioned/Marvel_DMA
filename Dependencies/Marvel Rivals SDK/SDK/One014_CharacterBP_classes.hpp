...
{
public:
	class UPhysicalInteractionComponent*          PhysicalInteraction;                               // 0x2200(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AOne014_CharacterBP_C) == 0x002210, "Wrong size on AOne014_CharacterBP_C");
static_assert(offsetof(AOne014_CharacterBP_C, PhysicalInteraction) == 0x002200, "Member 'AOne014_CharacterBP_C::PhysicalInteraction' has a wrong offset!");
