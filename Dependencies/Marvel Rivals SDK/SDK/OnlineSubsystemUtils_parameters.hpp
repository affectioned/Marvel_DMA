...
// Function OnlineSubsystemUtils.IpConnection.LowLevelGetRemoteAddress
// 0x0018 (0x0018 - 0x0000)
struct IpConnection_LowLevelGetRemoteAddress final
{
public:
...
static_assert(alignof(IpConnection_LowLevelGetRemoteAddress) == 0x000008, "Wrong alignment on IpConnection_LowLevelGetRemoteAddress");
static_assert(sizeof(IpConnection_LowLevelGetRemoteAddress) == 0x000018, "Wrong size on IpConnection_LowLevelGetRemoteAddress");
static_assert(offsetof(IpConnection_LowLevelGetRemoteAddress, bAppendPort) == 0x000000, "Member 'IpConnection_LowLevelGetRemoteAddress::bAppendPort' has a wrong offset!");
static_assert(offsetof(IpConnection_LowLevelGetRemoteAddress, ReturnValue) == 0x000008, "Member 'IpConnection_LowLevelGetRemoteAddress::ReturnValue' has a wrong offset!");
