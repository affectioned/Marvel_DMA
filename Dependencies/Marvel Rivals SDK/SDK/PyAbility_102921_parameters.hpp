...
static_assert(alignof(PyAbility_102921_OnOwnerApplyDamage) == 0x000008, "Wrong alignment on PyAbility_102921_OnOwnerApplyDamage");
static_assert(sizeof(PyAbility_102921_OnOwnerApplyDamage) == 0x000028, "Wrong size on PyAbility_102921_OnOwnerApplyDamage");
static_assert(offsetof(PyAbility_102921_OnOwnerApplyDamage, InSource) == 0x000000, "Member 'PyAbility_102921_OnOwnerApplyDamage::InSource' has a wrong offset!");
static_assert(offsetof(PyAbility_102921_OnOwnerApplyDamage, InTarget) == 0x000008, "Member 'PyAbility_102921_OnOwnerApplyDamage::InTarget' has a wrong offset!");
static_assert(offsetof(PyAbility_102921_OnOwnerApplyDamage, ModifierParameterHandle) == 0x000010, "Member 'PyAbility_102921_OnOwnerApplyDamage::ModifierParameterHandle' has a wrong offset!");
...
static_assert(sizeof(PyCue_Ability_Loop_10292101_WhileActiveFX) == 0x0001D8, "Wrong size on PyCue_Ability_Loop_10292101_WhileActiveFX");
...
static_assert(sizeof(PyCue_Ability_Loop_10292101_OnRemoveFX) == 0x0001D8, "Wrong size on PyCue_Ability_Loop_10292101_OnRemoveFX");
...
static_assert(sizeof(PyCue_Projectile_Loop_10292101_WhileActiveFX) == 0x0001D8, "Wrong size on PyCue_Projectile_Loop_10292101_WhileActiveFX");
...
static_assert(sizeof(PyCue_Projectile_Loop_10292101_OnRemoveFX) == 0x0001D8, "Wrong size on PyCue_Projectile_Loop_10292101_OnRemoveFX");
