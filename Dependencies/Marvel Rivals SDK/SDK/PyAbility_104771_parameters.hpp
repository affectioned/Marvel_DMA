...
static_assert(offsetof(PyAbility_104771_New_OnMovementModeChanged, char_0) == 0x000000, "Member 'PyAbility_104771_New_OnMovementModeChanged::char_0' has a wrong offset!");
...
static_assert(alignof(PyAbility_104771_New_OnStormStateNetSync) == 0x000008, "Wrong alignment on PyAbility_104771_New_OnStormStateNetSync");
static_assert(sizeof(PyAbility_104771_New_OnStormStateNetSync) == 0x000168, "Wrong size on PyAbility_104771_New_OnStormStateNetSync");
static_assert(offsetof(PyAbility_104771_New_OnStormStateNetSync, Data) == 0x000000, "Member 'PyAbility_104771_New_OnStormStateNetSync::Data' has a wrong offset!");
...
static_assert(sizeof(PyCue_Buff_10477110_OnRemoveFX) == 0x0001D8, "Wrong size on PyCue_Buff_10477110_OnRemoveFX");
...
static_assert(alignof(PyCue_AbilityLoop_10477105_WhileActive) == 0x000008, "Wrong alignment on PyCue_AbilityLoop_10477105_WhileActive");
static_assert(sizeof(PyCue_AbilityLoop_10477105_WhileActive) == 0x0001E0, "Wrong size on PyCue_AbilityLoop_10477105_WhileActive");
static_assert(offsetof(PyCue_AbilityLoop_10477105_WhileActive, MyTarget) == 0x000000, "Member 'PyCue_AbilityLoop_10477105_WhileActive::MyTarget' has a wrong offset!");
static_assert(offsetof(PyCue_AbilityLoop_10477105_WhileActive, Parameters) == 0x000008, "Member 'PyCue_AbilityLoop_10477105_WhileActive::Parameters' has a wrong offset!");
static_assert(offsetof(PyCue_AbilityLoop_10477105_WhileActive, ReturnValue) == 0x0001D8, "Member 'PyCue_AbilityLoop_10477105_WhileActive::ReturnValue' has a wrong offset!");
...
static_assert(alignof(PyCue_AbilityLoop_10477105_OnRemove) == 0x000008, "Wrong alignment on PyCue_AbilityLoop_10477105_OnRemove");
static_assert(sizeof(PyCue_AbilityLoop_10477105_OnRemove) == 0x0001E0, "Wrong size on PyCue_AbilityLoop_10477105_OnRemove");
static_assert(offsetof(PyCue_AbilityLoop_10477105_OnRemove, MyTarget) == 0x000000, "Member 'PyCue_AbilityLoop_10477105_OnRemove::MyTarget' has a wrong offset!");
static_assert(offsetof(PyCue_AbilityLoop_10477105_OnRemove, Parameters) == 0x000008, "Member 'PyCue_AbilityLoop_10477105_OnRemove::Parameters' has a wrong offset!");
static_assert(offsetof(PyCue_AbilityLoop_10477105_OnRemove, ReturnValue) == 0x0001D8, "Member 'PyCue_AbilityLoop_10477105_OnRemove::ReturnValue' has a wrong offset!");
...
static_assert(alignof(PyCue_AbilityLoop_10477105_OnTagUpdate) == 0x000004, "Wrong alignment on PyCue_AbilityLoop_10477105_OnTagUpdate");
static_assert(sizeof(PyCue_AbilityLoop_10477105_OnTagUpdate) == 0x000010, "Wrong size on PyCue_AbilityLoop_10477105_OnTagUpdate");
static_assert(offsetof(PyCue_AbilityLoop_10477105_OnTagUpdate, Tag) == 0x000000, "Member 'PyCue_AbilityLoop_10477105_OnTagUpdate::Tag' has a wrong offset!");
static_assert(offsetof(PyCue_AbilityLoop_10477105_OnTagUpdate, Exist) == 0x00000C, "Member 'PyCue_AbilityLoop_10477105_OnTagUpdate::Exist' has a wrong offset!");
...
static_assert(sizeof(PyCue_Scope_HitImpact_10477101_OnExecuteAudio) == 0x0001D8, "Wrong size on PyCue_Scope_HitImpact_10477101_OnExecuteAudio");
