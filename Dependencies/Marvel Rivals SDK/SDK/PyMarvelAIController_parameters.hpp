...
static_assert(sizeof(PyMarvelAIController_OnAIReborn) == 0x000820, "Wrong size on PyMarvelAIController_OnAIReborn");
...
static_assert(alignof(PyMarvelAIController_ReceiveRecommendedHeroUpdate) == 0x000004, "Wrong alignment on PyMarvelAIController_ReceiveRecommendedHeroUpdate");
static_assert(sizeof(PyMarvelAIController_ReceiveRecommendedHeroUpdate) == 0x000004, "Wrong size on PyMarvelAIController_ReceiveRecommendedHeroUpdate");
static_assert(offsetof(PyMarvelAIController_ReceiveRecommendedHeroUpdate, NewRecommendedHeroID) == 0x000000, "Member 'PyMarvelAIController_ReceiveRecommendedHeroUpdate::NewRecommendedHeroID' has a wrong offset!");
