...
void UPyWidget_CareerPlayerInfo::OnCascadingVisibleChanged(bool bNewVisible)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CareerPlayerInfo", "OnCascadingVisibleChanged");

	Params::PyWidget_CareerPlayerInfo_OnCascadingVisibleChanged Parms{};
...
void UPyWidget_CareerPlayerInfo::OnAnimationFinished(const class UWidgetAnimation* Animation)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CareerPlayerInfo", "OnAnimationFinished");

	Params::PyWidget_CareerPlayerInfo_OnAnimationFinished Parms{};
...
// PythonFunction PyWidget_CareerPlayerInfo.PyWidget_DiscordInfoTips.Construct
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidget_DiscordInfoTips::Construct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_DiscordInfoTips", "Construct");
