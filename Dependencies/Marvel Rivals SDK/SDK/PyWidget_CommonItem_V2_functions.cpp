...
void UPyWidget_CommonItem::OnCascadingVisibleChanged(bool visible)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CommonItem", "OnCascadingVisibleChanged");

	Params::PyWidget_CommonItem_OnCascadingVisibleChanged Parms{};
...
void UPyWidget_CommonItem::SetItemObject(class UObject* ItemObject_0)
{
	static class UFunction* Func = nullptr;
...
void UPyWidget_CommonItem::SetItemData(const class FString& ItemID_0, EItemType ItemType_0, int32 ItemNum_0, int32 Multiple, bool Small, bool DisableDynamic, const class FString& ItemUID)
{
	static class UFunction* Func = nullptr;
...
// (Native, Public, BlueprintCallable)
// Parameters:
// bool                                    IsPreviewing_0                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPyWidget_CommonItem::SetIsPreviewing(bool IsPreviewing_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CommonItem", "SetIsPreviewing");

	Params::PyWidget_CommonItem_SetIsPreviewing Parms{};

	Parms.IsPreviewing_0 = IsPreviewing_0;
