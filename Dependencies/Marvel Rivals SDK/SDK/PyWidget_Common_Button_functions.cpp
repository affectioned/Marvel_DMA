...
// Parameters:
// const struct FSlateColor&               color                                                  (ConstParm, Parm, OutParm, ReferenceParm)
// const struct FSlateColor&               disable_color                                          (ConstParm, Parm, OutParm, ReferenceParm)
...
void UPyWidget_CommonButton_Icon::OnCascadingVisibleChanged(bool visible)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CommonButton_Icon", "OnCascadingVisibleChanged");

	Params::PyWidget_CommonButton_Icon_OnCascadingVisibleChanged Parms{};
