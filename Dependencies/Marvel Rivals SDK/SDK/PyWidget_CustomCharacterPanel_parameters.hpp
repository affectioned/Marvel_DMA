...
// PythonFunction PyWidget_CustomCharacterPanel.PyWidget_CustomCharacterPanel.OnCascadingVisibleChanged
// 0x0001 (0x0001 - 0x0000)
struct PyWidget_CustomCharacterPanel_OnCascadingVisibleChanged final
{
public:
	bool                                          bNewVisible;                                       // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(PyWidget_CustomCharacterPanel_OnCascadingVisibleChanged) == 0x000001, "Wrong alignment on PyWidget_CustomCharacterPanel_OnCascadingVisibleChanged");
static_assert(sizeof(PyWidget_CustomCharacterPanel_OnCascadingVisibleChanged) == 0x000001, "Wrong size on PyWidget_CustomCharacterPanel_OnCascadingVisibleChanged");
static_assert(offsetof(PyWidget_CustomCharacterPanel_OnCascadingVisibleChanged, bNewVisible) == 0x000000, "Member 'PyWidget_CustomCharacterPanel_OnCascadingVisibleChanged::bNewVisible' has a wrong offset!");
