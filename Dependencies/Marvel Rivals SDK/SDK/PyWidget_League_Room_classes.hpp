...
public:
	...
	struct FMargin                                CountDown_Padding_Ready;                           // 0x07C4(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                CountDown_Padding_Unready;                         // 0x07D4(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FSlateColor                            TitleTextColorMRC;                                 // 0x07E4(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            TitleTextColorClash;                               // 0x07F8(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            ContentTextColorMRC;                               // 0x080C(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            ContentTextColorClash;                             // 0x0820(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
