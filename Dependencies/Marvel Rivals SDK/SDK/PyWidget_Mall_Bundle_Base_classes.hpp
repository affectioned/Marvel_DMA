...
{
public:
	EStoreRowCardType                             WindowType;                                        // 0x05BA(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPyWidget_Mall_Bundle_Base) == 0x0005C0, "Wrong size on UPyWidget_Mall_Bundle_Base");
static_assert(offsetof(UPyWidget_Mall_Bundle_Base, WindowType) == 0x0005BA, "Member 'UPyWidget_Mall_Bundle_Base::WindowType' has a wrong offset!");
