...
public:
	...
	TArray<struct FSlateBrush>                    ChampionIamge;                                     // 0x0870(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<struct FSlateBrush>                    RankImage;                                         // 0x0880(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<float>                                 RankImageAnimTime;                                 // 0x0890(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NativeAccessSpecifierPublic)
