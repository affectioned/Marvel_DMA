...
public:
	...
	uint8                                         Pad_5B8[0x380];                                    // 0x05B8(0x0380)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UReplicationGraph) == 0x000940, "Wrong size on UReplicationGraph");
...
static_assert(offsetof(UReplicationGraph, SharedConnection) == 0x0005B0, "Member 'UReplicationGraph::SharedConnection' has a wrong offset!");
...
{
public:
	class UReplicationGraphNode_GridSpatialization2D* GridNode;                                      // 0x0938(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UReplicationGraphNode_ActorList*        AlwaysRelevantNode;                                // 0x0940(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FConnectionAlwaysRelevantNodePair> AlwaysRelevantForConnectionList;                // 0x0948(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         ActorsWithoutNetConnection;                        // 0x0958(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBasicReplicationGraph) == 0x000970, "Wrong size on UBasicReplicationGraph");
static_assert(offsetof(UBasicReplicationGraph, GridNode) == 0x000938, "Member 'UBasicReplicationGraph::GridNode' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, AlwaysRelevantNode) == 0x000940, "Member 'UBasicReplicationGraph::AlwaysRelevantNode' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, AlwaysRelevantForConnectionList) == 0x000948, "Member 'UBasicReplicationGraph::AlwaysRelevantForConnectionList' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, ActorsWithoutNetConnection) == 0x000958, "Member 'UBasicReplicationGraph::ActorsWithoutNetConnection' has a wrong offset!");
...
static_assert(sizeof(UNetReplicationGraphConnection) == 0x0008D8, "Wrong size on UNetReplicationGraphConnection");
...
static_assert(offsetof(UNetReplicationGraphConnection, DebugActor) == 0x0006D4, "Member 'UNetReplicationGraphConnection::DebugActor' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, LastGatherLocations) == 0x0006E0, "Member 'UNetReplicationGraphConnection::LastGatherLocations' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, ConnectionGraphNodes) == 0x0007A0, "Member 'UNetReplicationGraphConnection::ConnectionGraphNodes' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, TearOffNode) == 0x0007B0, "Member 'UNetReplicationGraphConnection::TearOffNode' has a wrong offset!");
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x06D8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x06E0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(AReplicationGraphDebugActor) == 0x000010, "Wrong alignment on AReplicationGraphDebugActor");
static_assert(sizeof(AReplicationGraphDebugActor) == 0x0006F0, "Wrong size on AReplicationGraphDebugActor");
static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x0006D8, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x0006E0, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");
