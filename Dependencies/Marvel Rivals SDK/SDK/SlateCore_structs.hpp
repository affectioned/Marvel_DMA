...
// ScriptStruct SlateCore.RichEditableExtraTextStyle
// 0x0278 (0x0280 - 0x0008)
struct FRichEditableExtraTextStyle final : public FSlateWidgetStyle
{
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateBrush                            BackgroundImageSelected;                           // 0x0010(0x00D0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BackgroundImageComposing;                          // 0x00E0(0x00D0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            CaretImage;                                        // 0x01B0(0x00D0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRichEditableExtraTextStyle) == 0x000010, "Wrong alignment on FRichEditableExtraTextStyle");
static_assert(sizeof(FRichEditableExtraTextStyle) == 0x000280, "Wrong size on FRichEditableExtraTextStyle");
static_assert(offsetof(FRichEditableExtraTextStyle, BackgroundImageSelected) == 0x000010, "Member 'FRichEditableExtraTextStyle::BackgroundImageSelected' has a wrong offset!");
static_assert(offsetof(FRichEditableExtraTextStyle, BackgroundImageComposing) == 0x0000E0, "Member 'FRichEditableExtraTextStyle::BackgroundImageComposing' has a wrong offset!");
static_assert(offsetof(FRichEditableExtraTextStyle, CaretImage) == 0x0001B0, "Member 'FRichEditableExtraTextStyle::CaretImage' has a wrong offset!");
