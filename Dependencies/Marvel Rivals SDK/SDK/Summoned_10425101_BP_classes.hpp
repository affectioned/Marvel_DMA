...
static_assert(sizeof(ASummoned_10425101_BP_C) == 0x001BC0, "Wrong size on ASummoned_10425101_BP_C");
static_assert(offsetof(ASummoned_10425101_BP_C, SummonedMovement) == 0x001BB0, "Member 'ASummoned_10425101_BP_C::SummonedMovement' has a wrong offset!");
