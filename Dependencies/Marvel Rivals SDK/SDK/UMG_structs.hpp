...
static_assert(sizeof(FWidgetAnimationCachedDataStore) == 0x000098, "Wrong size on FWidgetAnimationCachedDataStore");
...
// ScriptStruct UMG.HashTextStyleRow
// 0x0350 (0x0360 - 0x0010)
struct FHashTextStyleRow final : public FTableRowBase
{
public:
	struct FTextBlockStyle                        TextStyle;                                         // 0x0010(0x0350)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FHashTextStyleRow) == 0x000010, "Wrong alignment on FHashTextStyleRow");
static_assert(sizeof(FHashTextStyleRow) == 0x000360, "Wrong size on FHashTextStyleRow");
static_assert(offsetof(FHashTextStyleRow, TextStyle) == 0x000010, "Member 'FHashTextStyleRow::TextStyle' has a wrong offset!");

// ScriptStruct UMG.HashTextMoodRow
// 0x0010 (0x0020 - 0x0010)
struct FHashTextMoodRow final : public FTableRowBase
{
public:
	class FString                                 ItemID;                                            // 0x0010(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FHashTextMoodRow) == 0x000008, "Wrong alignment on FHashTextMoodRow");
static_assert(sizeof(FHashTextMoodRow) == 0x000020, "Wrong size on FHashTextMoodRow");
static_assert(offsetof(FHashTextMoodRow, ItemID) == 0x000010, "Member 'FHashTextMoodRow::ItemID' has a wrong offset!");
...
// ScriptStruct UMG.HashTextDecoratorStyleRow
// 0x0350 (0x0360 - 0x0010)
struct FHashTextDecoratorStyleRow final : public FTableRowBase
{
public:
	struct FTextBlockStyle                        TextStyle;                                         // 0x0010(0x0350)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FHashTextDecoratorStyleRow) == 0x000010, "Wrong alignment on FHashTextDecoratorStyleRow");
static_assert(sizeof(FHashTextDecoratorStyleRow) == 0x000360, "Wrong size on FHashTextDecoratorStyleRow");
static_assert(offsetof(FHashTextDecoratorStyleRow, TextStyle) == 0x000010, "Member 'FHashTextDecoratorStyleRow::TextStyle' has a wrong offset!");

// ScriptStruct UMG.HashTextDecoratorStyleConfig
// 0x0008 (0x0008 - 0x0000)
struct FHashTextDecoratorStyleConfig
{
public:
...
static_assert(alignof(FHashTextDecoratorStyleConfig) == 0x000008, "Wrong alignment on FHashTextDecoratorStyleConfig");
static_assert(sizeof(FHashTextDecoratorStyleConfig) == 0x000008, "Wrong size on FHashTextDecoratorStyleConfig");
static_assert(offsetof(FHashTextDecoratorStyleConfig, DecoratorStyleSet) == 0x000000, "Member 'FHashTextDecoratorStyleConfig::DecoratorStyleSet' has a wrong offset!");
...
public:
	...
	class FName                                   ActivityID;                                        // 0x0464(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FRichImageTextRow, ActivityID) == 0x000464, "Member 'FRichImageTextRow::ActivityID' has a wrong offset!");
