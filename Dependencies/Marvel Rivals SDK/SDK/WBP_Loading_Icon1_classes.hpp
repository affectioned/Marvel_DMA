...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_Loading_Icon1_C">();
	}
...
static_assert(alignof(UWBP_Loading_Icon1_C) == 0x000008, "Wrong alignment on UWBP_Loading_Icon1_C");
static_assert(sizeof(UWBP_Loading_Icon1_C) == 0x0005B8, "Wrong size on UWBP_Loading_Icon1_C");
static_assert(offsetof(UWBP_Loading_Icon1_C, Img_Loading) == 0x000578, "Member 'UWBP_Loading_Icon1_C::Img_Loading' has a wrong offset!");
static_assert(offsetof(UWBP_Loading_Icon1_C, Img_Loading_Bg) == 0x000580, "Member 'UWBP_Loading_Icon1_C::Img_Loading_Bg' has a wrong offset!");
static_assert(offsetof(UWBP_Loading_Icon1_C, Img_Loading_Glow) == 0x000588, "Member 'UWBP_Loading_Icon1_C::Img_Loading_Glow' has a wrong offset!");
static_assert(offsetof(UWBP_Loading_Icon1_C, Img_Loading_Left) == 0x000590, "Member 'UWBP_Loading_Icon1_C::Img_Loading_Left' has a wrong offset!");
static_assert(offsetof(UWBP_Loading_Icon1_C, Img_Loading_Left_Light) == 0x000598, "Member 'UWBP_Loading_Icon1_C::Img_Loading_Left_Light' has a wrong offset!");
static_assert(offsetof(UWBP_Loading_Icon1_C, Img_Loading_Light) == 0x0005A0, "Member 'UWBP_Loading_Icon1_C::Img_Loading_Light' has a wrong offset!");
static_assert(offsetof(UWBP_Loading_Icon1_C, Img_Loading_Right) == 0x0005A8, "Member 'UWBP_Loading_Icon1_C::Img_Loading_Right' has a wrong offset!");
static_assert(offsetof(UWBP_Loading_Icon1_C, Img_Loading_Right_Light) == 0x0005B0, "Member 'UWBP_Loading_Icon1_C::Img_Loading_Right_Light' has a wrong offset!");
