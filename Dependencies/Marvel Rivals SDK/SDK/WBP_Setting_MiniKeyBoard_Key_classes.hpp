...
public:
	...
	struct FLinearColor                           ConflictColor;                                     // 0x06F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                             Image_0;                                           // 0x0708(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Setting_MiniKeyBoard_Key_C) == 0x000710, "Wrong size on UWBP_Setting_MiniKeyBoard_Key_C");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, UberGraphFrame) == 0x0005C0, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Bg_Key) == 0x0005C8, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Bg_Key' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Btn_Key) == 0x0005D0, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Btn_Key' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Icon_Key) == 0x0005D8, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Icon_Key' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Overlay_Key) == 0x0005E0, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Overlay_Key' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, SizeBox_Key) == 0x0005E8, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::SizeBox_Key' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Text_KeyName) == 0x0005F0, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Text_KeyName' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, SetIcon) == 0x0005F8, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::SetIcon' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Name_0) == 0x000600, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Name_0' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Font) == 0x000618, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Font' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Width) == 0x000680, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Width' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Height) == 0x000688, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Height' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Normal) == 0x000690, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Normal' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Combine) == 0x000698, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Combine' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, IsCombine) == 0x0006A0, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::IsCombine' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Text_Color_Combine) == 0x0006A4, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Text_Color_Combine' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Text_Color_Normal) == 0x0006B8, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Text_Color_Normal' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, IsDisable) == 0x0006CC, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::IsDisable' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, IsConflict) == 0x0006CD, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::IsConflict' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Conflict) == 0x0006D0, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Conflict' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, NormalColor) == 0x0006D8, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::NormalColor' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, CombineColor) == 0x0006E8, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::CombineColor' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, ConflictColor) == 0x0006F8, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::ConflictColor' has a wrong offset!");
static_assert(offsetof(UWBP_Setting_MiniKeyBoard_Key_C, Image_0) == 0x000708, "Member 'UWBP_Setting_MiniKeyBoard_Key_C::Image_0' has a wrong offset!");
